...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.BitstampPublicApi);
  }
}(this, function(expect, BitstampPublicApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new BitstampPublicApi.OrdersApi();
  });
  ...
  describe('OrdersApi', function() {
    describe('cancelAllOrders', function() {
      it('should call cancelAllOrders successfully', function(done) {
        //uncomment below and update the code to test cancelAllOrders
        //instance.cancelAllOrders(function(error) {
    ...
    describe('cancelOrdersForMarket', function() {
      it('should call cancelOrdersForMarket successfully', function(done) {
        //uncomment below and update the code to test cancelOrdersForMarket
        //instance.cancelOrdersForMarket(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllOpenOrders', function() {
      it('should call getAllOpenOrders successfully', function(done) {
        //uncomment below and update the code to test getAllOpenOrders
        //instance.getAllOpenOrders(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getOpenOrdersForMarket', function() {
      it('should call getOpenOrdersForMarket successfully', function(done) {
        //uncomment below and update the code to test getOpenOrdersForMarket
        //instance.getOpenOrdersForMarket(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUserTradingMarkets', function() {
      it('should call getUserTradingMarkets successfully', function(done) {
        //uncomment below and update the code to test getUserTradingMarkets
        //instance.getUserTradingMarkets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openInstantBuyOrder', function() {
      it('should call openInstantBuyOrder successfully', function(done) {
        //uncomment below and update the code to test openInstantBuyOrder
        //instance.openInstantBuyOrder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openInstantSellOrder', function() {
      it('should call openInstantSellOrder successfully', function(done) {
        //uncomment below and update the code to test openInstantSellOrder
        //instance.openInstantSellOrder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openLimitBuyOrder', function() {
      it('should call openLimitBuyOrder successfully', function(done) {
        //uncomment below and update the code to test openLimitBuyOrder
        //instance.openLimitBuyOrder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openLimitSellOrder', function() {
      it('should call openLimitSellOrder successfully', function(done) {
        //uncomment below and update the code to test openLimitSellOrder
        //instance.openLimitSellOrder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openMarketBuyOrder', function() {
      it('should call openMarketBuyOrder successfully', function(done) {
        //uncomment below and update the code to test openMarketBuyOrder
        //instance.openMarketBuyOrder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openMarketSellOrder', function() {
      it('should call openMarketSellOrder successfully', function(done) {
        //uncomment below and update the code to test openMarketSellOrder
        //instance.openMarketSellOrder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
