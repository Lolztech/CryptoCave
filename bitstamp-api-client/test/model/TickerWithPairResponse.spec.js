...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitstampPublicApi.TickerWithPairResponse();
  });
  ...
  describe('TickerWithPairResponse', function() {
    it('should create an instance of TickerWithPairResponse', function() {
      // uncomment below and update the code to test TickerWithPairResponse
      //var instance = new BitstampPublicApi.TickerWithPairResponse();
      //expect(instance).to.be.a(BitstampPublicApi.TickerWithPairResponse);
    });
    ...
    it('should have the property open24 (base name: "open_24")', function() {
      // uncomment below and update the code to test the property open24
      //var instance = new BitstampPublicApi.TickerWithPairResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property percentChange24 (base name: "percent_change_24")', function() {
      // uncomment below and update the code to test the property percentChange24
      //var instance = new BitstampPublicApi.TickerWithPairResponse();
      //expect(instance).to.be();
    });
