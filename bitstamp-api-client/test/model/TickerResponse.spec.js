...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitstampPublicApi.TickerResponse();
  });
  ...
  describe('TickerResponse', function() {
    it('should create an instance of TickerResponse', function() {
      // uncomment below and update the code to test TickerResponse
      //var instance = new BitstampPublicApi.TickerResponse();
      //expect(instance).to.be.a(BitstampPublicApi.TickerResponse);
    });
