...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitstampPublicApi.OpenBankWithdrawalRequest();
  });
  ...
  describe('OpenBankWithdrawalRequest', function() {
    it('should create an instance of OpenBankWithdrawalRequest', function() {
      // uncomment below and update the code to test OpenBankWithdrawalRequest
      //var instance = new BitstampPublicApi.OpenBankWithdrawalRequest();
      //expect(instance).to.be.a(BitstampPublicApi.OpenBankWithdrawalRequest);
    });

    it('should have the property accountCurrency (base name: "account_currency")', function() {
    ...
    it('should have the property bankCity (base name: "bank_city")', function() {
    ...
    it('should have the property bankPostalCode (base name: "bank_postal_code")', function() {
      // uncomment below and update the code to test the property bankPostalCode
      //var instance = new BitstampPublicApi.OpenBankWithdrawalRequest();
      //expect(instance).to.be();
    });
