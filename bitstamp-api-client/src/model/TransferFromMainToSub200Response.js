...
import TransferToFromMainResponse from './TransferToFromMainResponse';

/**
 * The TransferFromMainToSub200Response model module.
 * @module model/TransferFromMainToSub200Response
 * @version v2
 */
class TransferFromMainToSub200Response {
    /**
     * Constructs a new <code>TransferFromMainToSub200Response</code>.
     * @alias module:model/TransferFromMainToSub200Response
     * @param {(module:model/ErrorResponse|module:model/TransferToFromMainResponse)} instance The actual instance to initialize TransferFromMainToSub200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "TransferToFromMainResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                TransferToFromMainResponse.validateJSON(instance); // throw an exception if no match
                // create TransferToFromMainResponse from JS object
                this.actualInstance = TransferToFromMainResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into TransferToFromMainResponse
            errorMessages.push("Failed to construct TransferToFromMainResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `TransferFromMainToSub200Response` with oneOf schemas ErrorResponse, TransferToFromMainResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `TransferFromMainToSub200Response` with oneOf schemas ErrorResponse, TransferToFromMainResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>TransferFromMainToSub200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransferFromMainToSub200Response} obj Optional instance to populate.
     * @return {module:model/TransferFromMainToSub200Response} The populated <code>TransferFromMainToSub200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new TransferFromMainToSub200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>TransferToFromMainResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/TransferToFromMainResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>TransferToFromMainResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/TransferToFromMainResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = TransferFromMainToSub200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of TransferFromMainToSub200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/TransferFromMainToSub200Response} An instance of TransferFromMainToSub200Response.
     */
    static fromJSON = function(json_string){
        return TransferFromMainToSub200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
TransferFromMainToSub200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
TransferFromMainToSub200Response.prototype['status'] = undefined;


TransferFromMainToSub200Response.OneOf = ["ErrorResponse", "TransferToFromMainResponse"];

export default TransferFromMainToSub200Response;
