...
import CryptoWithdrawalResponse from './CryptoWithdrawalResponse';
import ErrorResponse from './ErrorResponse';

/**
 * The RequestCryptoWithdrawal200Response model module.
 * @module model/RequestCryptoWithdrawal200Response
 * @version v2
 */
class RequestCryptoWithdrawal200Response {
    /**
     * Constructs a new <code>RequestCryptoWithdrawal200Response</code>.
     * @alias module:model/RequestCryptoWithdrawal200Response
     * @param {(module:model/CryptoWithdrawalResponse|module:model/ErrorResponse)} instance The actual instance to initialize RequestCryptoWithdrawal200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "CryptoWithdrawalResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CryptoWithdrawalResponse.validateJSON(instance); // throw an exception if no match
                // create CryptoWithdrawalResponse from JS object
                this.actualInstance = CryptoWithdrawalResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CryptoWithdrawalResponse
            errorMessages.push("Failed to construct CryptoWithdrawalResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `RequestCryptoWithdrawal200Response` with oneOf schemas CryptoWithdrawalResponse, ErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `RequestCryptoWithdrawal200Response` with oneOf schemas CryptoWithdrawalResponse, ErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>RequestCryptoWithdrawal200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestCryptoWithdrawal200Response} obj Optional instance to populate.
     * @return {module:model/RequestCryptoWithdrawal200Response} The populated <code>RequestCryptoWithdrawal200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new RequestCryptoWithdrawal200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>CryptoWithdrawalResponse</code>, <code>ErrorResponse</code>.
     * @return {(module:model/CryptoWithdrawalResponse|module:model/ErrorResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CryptoWithdrawalResponse</code>, <code>ErrorResponse</code>.
     * @param {(module:model/CryptoWithdrawalResponse|module:model/ErrorResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = RequestCryptoWithdrawal200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of RequestCryptoWithdrawal200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/RequestCryptoWithdrawal200Response} An instance of RequestCryptoWithdrawal200Response.
     */
    static fromJSON = function(json_string){
        return RequestCryptoWithdrawal200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 * @member {Number} id
 */
RequestCryptoWithdrawal200Response.prototype['id'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
RequestCryptoWithdrawal200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
RequestCryptoWithdrawal200Response.prototype['status'] = undefined;


RequestCryptoWithdrawal200Response.OneOf = ["CryptoWithdrawalResponse", "ErrorResponse"];

export default RequestCryptoWithdrawal200Response;
