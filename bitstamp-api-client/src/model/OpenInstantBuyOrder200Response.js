...
import BuySellOrderResponse from './BuySellOrderResponse';
import ErrorResponse from './ErrorResponse';

/**
 * The OpenInstantBuyOrder200Response model module.
 * @module model/OpenInstantBuyOrder200Response
 * @version v2
 */
class OpenInstantBuyOrder200Response {
    /**
     * Constructs a new <code>OpenInstantBuyOrder200Response</code>.
     * @alias module:model/OpenInstantBuyOrder200Response
     * @param {(module:model/BuySellOrderResponse|module:model/ErrorResponse)} instance The actual instance to initialize OpenInstantBuyOrder200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "BuySellOrderResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                BuySellOrderResponse.validateJSON(instance); // throw an exception if no match
                // create BuySellOrderResponse from JS object
                this.actualInstance = BuySellOrderResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into BuySellOrderResponse
            errorMessages.push("Failed to construct BuySellOrderResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `OpenInstantBuyOrder200Response` with oneOf schemas BuySellOrderResponse, ErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `OpenInstantBuyOrder200Response` with oneOf schemas BuySellOrderResponse, ErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>OpenInstantBuyOrder200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenInstantBuyOrder200Response} obj Optional instance to populate.
     * @return {module:model/OpenInstantBuyOrder200Response} The populated <code>OpenInstantBuyOrder200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new OpenInstantBuyOrder200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>BuySellOrderResponse</code>, <code>ErrorResponse</code>.
     * @return {(module:model/BuySellOrderResponse|module:model/ErrorResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>BuySellOrderResponse</code>, <code>ErrorResponse</code>.
     * @param {(module:model/BuySellOrderResponse|module:model/ErrorResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = OpenInstantBuyOrder200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of OpenInstantBuyOrder200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/OpenInstantBuyOrder200Response} An instance of OpenInstantBuyOrder200Response.
     */
    static fromJSON = function(json_string){
        return OpenInstantBuyOrder200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 * @member {String} id
 */
OpenInstantBuyOrder200Response.prototype['id'] = undefined;

/**
 * Market formatted as \"BTC/USD\".
 * @member {String} market
 */
OpenInstantBuyOrder200Response.prototype['market'] = undefined;

/**
 * Date and time.
 * @member {Date} datetime
 */
OpenInstantBuyOrder200Response.prototype['datetime'] = undefined;

/**
 * 0 (buy) or 1 (sell).
 * @member {String} type
 */
OpenInstantBuyOrder200Response.prototype['type'] = undefined;

/**
 * Price.
 * @member {String} price
 */
OpenInstantBuyOrder200Response.prototype['price'] = undefined;

/**
 * Amount.
 * @member {String} amount
 */
OpenInstantBuyOrder200Response.prototype['amount'] = undefined;

/**
 * Client order ID sent with request. Only returned if parameter was used in request.
 * @member {String} client_order_id
 */
OpenInstantBuyOrder200Response.prototype['client_order_id'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
OpenInstantBuyOrder200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
OpenInstantBuyOrder200Response.prototype['status'] = undefined;


OpenInstantBuyOrder200Response.OneOf = ["BuySellOrderResponse", "ErrorResponse"];

export default OpenInstantBuyOrder200Response;
