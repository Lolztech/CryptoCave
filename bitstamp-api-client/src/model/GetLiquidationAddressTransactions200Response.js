...
import InstantConvertAddressInfoResponse from './InstantConvertAddressInfoResponse';

/**
 * The GetLiquidationAddressTransactions200Response model module.
 * @module model/GetLiquidationAddressTransactions200Response
 * @version v2
 */
class GetLiquidationAddressTransactions200Response {
    /**
     * Constructs a new <code>GetLiquidationAddressTransactions200Response</code>.
     * @alias module:model/GetLiquidationAddressTransactions200Response
     * @param {(module:model/ErrorResponse|module:model/[InstantConvertAddressInfoResponse])} instance The actual instance to initialize GetLiquidationAddressTransactions200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "[InstantConvertAddressInfoResponse]") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                [InstantConvertAddressInfoResponse].validateJSON(instance); // throw an exception if no match
                // create [InstantConvertAddressInfoResponse] from JS object
                this.actualInstance = [InstantConvertAddressInfoResponse].constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into [InstantConvertAddressInfoResponse]
            errorMessages.push("Failed to construct [InstantConvertAddressInfoResponse]: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetLiquidationAddressTransactions200Response` with oneOf schemas ErrorResponse, [InstantConvertAddressInfoResponse]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetLiquidationAddressTransactions200Response` with oneOf schemas ErrorResponse, [InstantConvertAddressInfoResponse]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetLiquidationAddressTransactions200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLiquidationAddressTransactions200Response} obj Optional instance to populate.
     * @return {module:model/GetLiquidationAddressTransactions200Response} The populated <code>GetLiquidationAddressTransactions200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetLiquidationAddressTransactions200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>[InstantConvertAddressInfoResponse]</code>.
     * @return {(module:model/ErrorResponse|module:model/[InstantConvertAddressInfoResponse])} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>[InstantConvertAddressInfoResponse]</code>.
     * @param {(module:model/ErrorResponse|module:model/[InstantConvertAddressInfoResponse])} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetLiquidationAddressTransactions200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetLiquidationAddressTransactions200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetLiquidationAddressTransactions200Response} An instance of GetLiquidationAddressTransactions200Response.
     */
    static fromJSON = function(json_string){
        return GetLiquidationAddressTransactions200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetLiquidationAddressTransactions200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetLiquidationAddressTransactions200Response.prototype['status'] = undefined;


GetLiquidationAddressTransactions200Response.OneOf = ["ErrorResponse", "[InstantConvertAddressInfoResponse]"];

export default GetLiquidationAddressTransactions200Response;
