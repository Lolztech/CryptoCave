...
class TickerResponse {
    ...
    constructor() { 
        ...
        TickerResponse.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TickerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TickerResponse</code>.
     */
 ...
 * @member {String} ask
 */
TickerResponse.prototype['ask'] = undefined;

/**
 * Highest buy order.
 * @member {String} bid
 */
TickerResponse.prototype['bid'] = undefined;

/**
 * Last 24 hours price high.
 * @member {String} high
 */
TickerResponse.prototype['high'] = undefined;

/**
 * Last price.
 * @member {String} last
 */
TickerResponse.prototype['last'] = undefined;

/**
 * Last 24 hours price low.
 * @member {String} low
 */
TickerResponse.prototype['low'] = undefined;

/**
 * First price of the day.
 * @member {String} open
 */
TickerResponse.prototype['open'] = undefined;

/**
 * 24 hours time delta transaction price
 * @member {String} open_24
 */
TickerResponse.prototype['open_24'] = undefined;

/**
 * 24 hours price change percent
 * @member {String} percent_change_24
 */
TickerResponse.prototype['percent_change_24'] = undefined;

/**
 * Ticker side: 0 - buy; 1 - sell.
 * @member {String} side
 */
TickerResponse.prototype['side'] = undefined;

/**
 * Unix timestamp date and time.
 * @member {String} timestamp
 */
TickerResponse.prototype['timestamp'] = undefined;

/**
 * Last 24 hours volume.
 * @member {String} volume
 */
TickerResponse.prototype['volume'] = undefined;

/**
 * Last 24 hours volume weighted average price.
 * @member {String} vwap
 */
TickerResponse.prototype['vwap'] = undefined;
