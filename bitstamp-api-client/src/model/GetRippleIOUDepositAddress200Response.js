...
import RippleIOUDepositAddressResponse from './RippleIOUDepositAddressResponse';

/**
 * The GetRippleIOUDepositAddress200Response model module.
 * @module model/GetRippleIOUDepositAddress200Response
 * @version v2
 */
class GetRippleIOUDepositAddress200Response {
    /**
     * Constructs a new <code>GetRippleIOUDepositAddress200Response</code>.
     * @alias module:model/GetRippleIOUDepositAddress200Response
     * @param {(module:model/ErrorResponse|module:model/RippleIOUDepositAddressResponse)} instance The actual instance to initialize GetRippleIOUDepositAddress200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "RippleIOUDepositAddressResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                RippleIOUDepositAddressResponse.validateJSON(instance); // throw an exception if no match
                // create RippleIOUDepositAddressResponse from JS object
                this.actualInstance = RippleIOUDepositAddressResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into RippleIOUDepositAddressResponse
            errorMessages.push("Failed to construct RippleIOUDepositAddressResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetRippleIOUDepositAddress200Response` with oneOf schemas ErrorResponse, RippleIOUDepositAddressResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetRippleIOUDepositAddress200Response` with oneOf schemas ErrorResponse, RippleIOUDepositAddressResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetRippleIOUDepositAddress200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRippleIOUDepositAddress200Response} obj Optional instance to populate.
     * @return {module:model/GetRippleIOUDepositAddress200Response} The populated <code>GetRippleIOUDepositAddress200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetRippleIOUDepositAddress200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>RippleIOUDepositAddressResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/RippleIOUDepositAddressResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>RippleIOUDepositAddressResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/RippleIOUDepositAddressResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetRippleIOUDepositAddress200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetRippleIOUDepositAddress200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetRippleIOUDepositAddress200Response} An instance of GetRippleIOUDepositAddress200Response.
     */
    static fromJSON = function(json_string){
        return GetRippleIOUDepositAddress200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetRippleIOUDepositAddress200Response.prototype['address'] = undefined;

/**
 * Destination tag.
 * @member {Number} destination_tag
 */
GetRippleIOUDepositAddress200Response.prototype['destination_tag'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
GetRippleIOUDepositAddress200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetRippleIOUDepositAddress200Response.prototype['status'] = undefined;


GetRippleIOUDepositAddress200Response.OneOf = ["ErrorResponse", "RippleIOUDepositAddressResponse"];

export default GetRippleIOUDepositAddress200Response;
