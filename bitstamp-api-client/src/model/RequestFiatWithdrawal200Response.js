...
import OpenBankWithdrawalResponse from './OpenBankWithdrawalResponse';

/**
 * The RequestFiatWithdrawal200Response model module.
 * @module model/RequestFiatWithdrawal200Response
 * @version v2
 */
class RequestFiatWithdrawal200Response {
    /**
     * Constructs a new <code>RequestFiatWithdrawal200Response</code>.
     * @alias module:model/RequestFiatWithdrawal200Response
     * @param {(module:model/ErrorResponse|module:model/OpenBankWithdrawalResponse)} instance The actual instance to initialize RequestFiatWithdrawal200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "OpenBankWithdrawalResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                OpenBankWithdrawalResponse.validateJSON(instance); // throw an exception if no match
                // create OpenBankWithdrawalResponse from JS object
                this.actualInstance = OpenBankWithdrawalResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into OpenBankWithdrawalResponse
            errorMessages.push("Failed to construct OpenBankWithdrawalResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `RequestFiatWithdrawal200Response` with oneOf schemas ErrorResponse, OpenBankWithdrawalResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `RequestFiatWithdrawal200Response` with oneOf schemas ErrorResponse, OpenBankWithdrawalResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>RequestFiatWithdrawal200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestFiatWithdrawal200Response} obj Optional instance to populate.
     * @return {module:model/RequestFiatWithdrawal200Response} The populated <code>RequestFiatWithdrawal200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new RequestFiatWithdrawal200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>OpenBankWithdrawalResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/OpenBankWithdrawalResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>OpenBankWithdrawalResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/OpenBankWithdrawalResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = RequestFiatWithdrawal200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of RequestFiatWithdrawal200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/RequestFiatWithdrawal200Response} An instance of RequestFiatWithdrawal200Response.
     */
    static fromJSON = function(json_string){
        return RequestFiatWithdrawal200Response.constructFromObject(JSON.parse(json_string));
    }
}

/**
 * Withdrawal ID.
 * @member {Number} withdrawal_id
 */
RequestFiatWithdrawal200Response.prototype['withdrawal_id'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
RequestFiatWithdrawal200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
RequestFiatWithdrawal200Response.prototype['status'] = undefined;


RequestFiatWithdrawal200Response.OneOf = ["ErrorResponse", "OpenBankWithdrawalResponse"];

export default RequestFiatWithdrawal200Response;
