...
/**
 * The OpenBankWithdrawalRequest model module.
 * @module model/OpenBankWithdrawalRequest
 * @version v2
 */
class OpenBankWithdrawalRequest {
    /**
     * Constructs a new <code>OpenBankWithdrawalRequest</code>.
     * @alias module:model/OpenBankWithdrawalRequest
     * @param accountCurrency {String} The balance from which you wish to withdraw. Can be either \"USD\", \"EUR\" or \"GBP\".
     * @param address {String} User or company address.
     * @param amount {String} The amount to withdraw.
     * @param bic {String} The target bank BIC.
     * @param city {String} User or company city.
     * @param country {String} User or company country. Country codes must be in accordance with the ISO 3166-1 standard (use two character Alpha-2 codes). Disclaimer: Not all country choices listed at this reference URL are supported. For a detailed list please refer to our platform's withdrawal interfaces.
     * @param iban {String} User or company IBAN.
     * @param name {String} Full user or company name.
     * @param postalCode {String} User or company postal code.
     * @param type {String} Type of the withdrawal request (\"sepa\" or \"international\").
     */
    constructor(accountCurrency, address, amount, bic, city, country, iban, name, postalCode, type) { 
        
        OpenBankWithdrawalRequest.initialize(this, accountCurrency, address, amount, bic, city, country, iban, name, postalCode, type);
    }
     ...
     */
    static initialize(obj, accountCurrency, address, amount, bic, city, country, iban, name, postalCode, type) { 
    ...
    /**
     * Constructs a <code>OpenBankWithdrawalRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenBankWithdrawalRequest} obj Optional instance to populate.
     * @return {module:model/OpenBankWithdrawalRequest} The populated <code>OpenBankWithdrawalRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenBankWithdrawalRequest();

            if (data.hasOwnProperty('account_currency')) {
                obj['account_currency'] = ApiClient.convertToType(data['account_currency'], 'String');
            }
            ...
            if (data.hasOwnProperty('bank_postal_code')) {
                obj['bank_postal_code'] = ApiClient.convertToType(data['bank_postal_code'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OpenBankWithdrawalRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpenBankWithdrawalRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OpenBankWithdrawalRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['account_currency'] && !(typeof data['account_currency'] === 'string' || data['account_currency'] instanceof String)) {
            throw new Error("Expected the field `account_currency` to be a primitive type in the JSON string but got " + data['account_currency']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['bank_postal_code'] && !(typeof data['bank_postal_code'] === 'string' || data['bank_postal_code'] instanceof String)) {
            throw new Error("Expected the field `bank_postal_code` to be a primitive type in the JSON string but got " + data['bank_postal_code']);
        }
        // ensure the json data is a string
...
OpenBankWithdrawalRequest.RequiredProperties = ["account_currency", "address", "amount", "bic", "city", "country", "iban", "name", "postal_code", "type"];

/**
 * The balance from which you wish to withdraw. Can be either \"USD\", \"EUR\" or \"GBP\".
 * @member {String} account_currency
 */
OpenBankWithdrawalRequest.prototype['account_currency'] = undefined;

/**
 * User or company address.
 * @member {String} address
 */
OpenBankWithdrawalRequest.prototype['address'] = undefined;

/**
 * The amount to withdraw.
 * @member {String} amount
 */
OpenBankWithdrawalRequest.prototype['amount'] = undefined;

/**
 * Target bank address (international withdrawals only).
 * @member {String} bank_address
 */
OpenBankWithdrawalRequest.prototype['bank_address'] = undefined;

/**
 * Target bank city (international withdrawals only).
 * @member {String} bank_city
 */
OpenBankWithdrawalRequest.prototype['bank_city'] = undefined;
 ...
 */
OpenBankWithdrawalRequest.prototype['bank_country'] = undefined;

/**
 * Target bank name (international withdrawals only).
 * @member {String} bank_name
 */
OpenBankWithdrawalRequest.prototype['bank_name'] = undefined;

/**
 * Target bank postal code (international withdrawals only).
 * @member {String} bank_postal_code
 */
OpenBankWithdrawalRequest.prototype['bank_postal_code'] = undefined;

/**
 * The target bank BIC.
 * @member {String} bic
 */
OpenBankWithdrawalRequest.prototype['bic'] = undefined;

/**
 * User or company city.
 * @member {String} city
 */
OpenBankWithdrawalRequest.prototype['city'] = undefined;

/**
 * Withdrawal comment.
 * @member {String} comment
 */
OpenBankWithdrawalRequest.prototype['comment'] = undefined;
 ...
 */
OpenBankWithdrawalRequest.prototype['country'] = undefined;
 ...
 */
OpenBankWithdrawalRequest.prototype['currency'] = undefined;

/**
 * User or company IBAN.
 * @member {String} iban
 */
OpenBankWithdrawalRequest.prototype['iban'] = undefined;

/**
 * Full user or company name.
 * @member {String} name
 */
OpenBankWithdrawalRequest.prototype['name'] = undefined;

/**
 * User or company postal code.
 * @member {String} postal_code
 */
OpenBankWithdrawalRequest.prototype['postal_code'] = undefined;

/**
 * Type of the withdrawal request (\"sepa\" or \"international\").
 * @member {String} type
 */
OpenBankWithdrawalRequest.prototype['type'] = undefined;
...
export default OpenBankWithdrawalRequest;
