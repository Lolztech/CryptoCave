...
/**
 * The TradingPairsInfoResponse model module.
 * @module model/TradingPairsInfoResponse
 * @version v2
 */
class TradingPairsInfoResponse {
    /**
     * Constructs a new <code>TradingPairsInfoResponse</code>.
     * @alias module:model/TradingPairsInfoResponse
     */
    constructor() { 
        
        TradingPairsInfoResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TradingPairsInfoResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TradingPairsInfoResponse} obj Optional instance to populate.
     * @return {module:model/TradingPairsInfoResponse} The populated <code>TradingPairsInfoResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TradingPairsInfoResponse();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('url_symbol')) {
                obj['url_symbol'] = ApiClient.convertToType(data['url_symbol'], 'String');
            }
            if (data.hasOwnProperty('base_decimals')) {
                obj['base_decimals'] = ApiClient.convertToType(data['base_decimals'], 'Number');
            }
            if (data.hasOwnProperty('counter_decimals')) {
                obj['counter_decimals'] = ApiClient.convertToType(data['counter_decimals'], 'Number');
            }
            if (data.hasOwnProperty('instant_order_counter_decimals')) {
                obj['instant_order_counter_decimals'] = ApiClient.convertToType(data['instant_order_counter_decimals'], 'Number');
            }
            if (data.hasOwnProperty('minimum_order')) {
                obj['minimum_order'] = ApiClient.convertToType(data['minimum_order'], 'String');
            }
            if (data.hasOwnProperty('trading')) {
                obj['trading'] = ApiClient.convertToType(data['trading'], 'String');
            }
            if (data.hasOwnProperty('instant_and_market_orders')) {
                obj['instant_and_market_orders'] = ApiClient.convertToType(data['instant_and_market_orders'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TradingPairsInfoResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TradingPairsInfoResponse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['url_symbol'] && !(typeof data['url_symbol'] === 'string' || data['url_symbol'] instanceof String)) {
            throw new Error("Expected the field `url_symbol` to be a primitive type in the JSON string but got " + data['url_symbol']);
        }
        // ensure the json data is a string
        if (data['minimum_order'] && !(typeof data['minimum_order'] === 'string' || data['minimum_order'] instanceof String)) {
            throw new Error("Expected the field `minimum_order` to be a primitive type in the JSON string but got " + data['minimum_order']);
        }
        // ensure the json data is a string
        if (data['trading'] && !(typeof data['trading'] === 'string' || data['trading'] instanceof String)) {
            throw new Error("Expected the field `trading` to be a primitive type in the JSON string but got " + data['trading']);
        }
        // ensure the json data is a string
        if (data['instant_and_market_orders'] && !(typeof data['instant_and_market_orders'] === 'string' || data['instant_and_market_orders'] instanceof String)) {
            throw new Error("Expected the field `instant_and_market_orders` to be a primitive type in the JSON string but got " + data['instant_and_market_orders']);
        }
        // ensure the json data is a string
 ...
 * @member {String} name
 */
TradingPairsInfoResponse.prototype['name'] = undefined;

/**
 * URL symbol of trading pair.
 * @member {String} url_symbol
 */
TradingPairsInfoResponse.prototype['url_symbol'] = undefined;

/**
 * Decimal precision for base currency (BTC/USD - base: BTC).
 * @member {Number} base_decimals
 */
TradingPairsInfoResponse.prototype['base_decimals'] = undefined;

/**
 * Decimal precision for counter currency (BTC/USD - counter: USD).
 * @member {Number} counter_decimals
 */
TradingPairsInfoResponse.prototype['counter_decimals'] = undefined;

/**
 * Decimal precision for counter currency for instant buy and cash sell orders.
 * @member {Number} instant_order_counter_decimals
 */
TradingPairsInfoResponse.prototype['instant_order_counter_decimals'] = undefined;

/**
 * Minimum order size.
 * @member {String} minimum_order
 */
TradingPairsInfoResponse.prototype['minimum_order'] = undefined;

/**
 * Trading engine status (Enabled/Disabled).
 * @member {module:model/TradingPairsInfoResponse.TradingEnum} trading
 */
TradingPairsInfoResponse.prototype['trading'] = undefined;

/**
 * Instant and market orders status (Enabled/Disabled).
 * @member {module:model/TradingPairsInfoResponse.InstantAndMarketOrdersEnum} instant_and_market_orders
 */
TradingPairsInfoResponse.prototype['instant_and_market_orders'] = undefined;

/**
 * Trading pair description.
 * @member {String} description
 */
TradingPairsInfoResponse.prototype['description'] = undefined;
...
/**
 * Allowed values for the <code>trading</code> property.
 * @enum {String}
 * @readonly
 */
TradingPairsInfoResponse['TradingEnum'] = {
...
/**
 * Allowed values for the <code>instant_and_market_orders</code> property.
 * @enum {String}
 * @readonly
 */
TradingPairsInfoResponse['InstantAndMarketOrdersEnum'] = {
...
export default TradingPairsInfoResponse;
