...
import CryptoTransactionsResponse from './CryptoTransactionsResponse';
import ErrorResponse from './ErrorResponse';

/**
 * The GetCryptoUserTransactions200Response model module.
 * @module model/GetCryptoUserTransactions200Response
 * @version v2
 */
class GetCryptoUserTransactions200Response {
    /**
     * Constructs a new <code>GetCryptoUserTransactions200Response</code>.
     * @alias module:model/GetCryptoUserTransactions200Response
     * @param {(module:model/CryptoTransactionsResponse|module:model/ErrorResponse)} instance The actual instance to initialize GetCryptoUserTransactions200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "CryptoTransactionsResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CryptoTransactionsResponse.validateJSON(instance); // throw an exception if no match
                // create CryptoTransactionsResponse from JS object
                this.actualInstance = CryptoTransactionsResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CryptoTransactionsResponse
            errorMessages.push("Failed to construct CryptoTransactionsResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetCryptoUserTransactions200Response` with oneOf schemas CryptoTransactionsResponse, ErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetCryptoUserTransactions200Response` with oneOf schemas CryptoTransactionsResponse, ErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetCryptoUserTransactions200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCryptoUserTransactions200Response} obj Optional instance to populate.
     * @return {module:model/GetCryptoUserTransactions200Response} The populated <code>GetCryptoUserTransactions200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetCryptoUserTransactions200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>CryptoTransactionsResponse</code>, <code>ErrorResponse</code>.
     * @return {(module:model/CryptoTransactionsResponse|module:model/ErrorResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CryptoTransactionsResponse</code>, <code>ErrorResponse</code>.
     * @param {(module:model/CryptoTransactionsResponse|module:model/ErrorResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetCryptoUserTransactions200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetCryptoUserTransactions200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetCryptoUserTransactions200Response} An instance of GetCryptoUserTransactions200Response.
     */
    static fromJSON = function(json_string){
        return GetCryptoUserTransactions200Response.constructFromObject(JSON.parse(json_string));
    }
}

/**
 * Deposits.
 * @member {Array.<module:model/CryptoTransaction>} deposits
 */
GetCryptoUserTransactions200Response.prototype['deposits'] = undefined;

/**
 * Ripple IOU transactions.
 * @member {Array.<module:model/CryptoTransaction>} ripple_iou_transactions
 */
GetCryptoUserTransactions200Response.prototype['ripple_iou_transactions'] = undefined;

/**
 * Withdrawals.
 * @member {Array.<module:model/CryptoTransaction>} withdrawals
 */
GetCryptoUserTransactions200Response.prototype['withdrawals'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
GetCryptoUserTransactions200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetCryptoUserTransactions200Response.prototype['status'] = undefined;


GetCryptoUserTransactions200Response.OneOf = ["CryptoTransactionsResponse", "ErrorResponse"];

export default GetCryptoUserTransactions200Response;
