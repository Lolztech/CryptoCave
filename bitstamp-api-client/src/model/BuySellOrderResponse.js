...
/**
 * The BuySellOrderResponse model module.
 * @module model/BuySellOrderResponse
 * @version v2
 */
class BuySellOrderResponse {
    /**
     * Constructs a new <code>BuySellOrderResponse</code>.
     * @alias module:model/BuySellOrderResponse
     */
    constructor() { 
        
        BuySellOrderResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BuySellOrderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuySellOrderResponse} obj Optional instance to populate.
     * @return {module:model/BuySellOrderResponse} The populated <code>BuySellOrderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuySellOrderResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BuySellOrderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BuySellOrderResponse</code>.
     */
 ...
 * @member {String} id
 */
BuySellOrderResponse.prototype['id'] = undefined;

/**
 * Market formatted as \"BTC/USD\".
 * @member {String} market
 */
BuySellOrderResponse.prototype['market'] = undefined;

/**
 * Date and time.
 * @member {Date} datetime
 */
BuySellOrderResponse.prototype['datetime'] = undefined;

/**
 * 0 (buy) or 1 (sell).
 * @member {String} type
 */
BuySellOrderResponse.prototype['type'] = undefined;

/**
 * Price.
 * @member {String} price
 */
BuySellOrderResponse.prototype['price'] = undefined;

/**
 * Amount.
 * @member {String} amount
 */
BuySellOrderResponse.prototype['amount'] = undefined;

/**
 * Client order ID sent with request. Only returned if parameter was used in request.
 * @member {String} client_order_id
 */
BuySellOrderResponse.prototype['client_order_id'] = undefined;
...
export default BuySellOrderResponse;
