...
/**
 * The GetOrderStatus200Response model module.
 * @module model/GetOrderStatus200Response
 * @version v2
 */
class GetOrderStatus200Response {
    /**
     * Constructs a new <code>GetOrderStatus200Response</code>.
     * @alias module:model/GetOrderStatus200Response
     * @param {(module:model/ErrorResponse|module:model/OrderStatusResponse)} instance The actual instance to initialize GetOrderStatus200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "OrderStatusResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                OrderStatusResponse.validateJSON(instance); // throw an exception if no match
                // create OrderStatusResponse from JS object
                this.actualInstance = OrderStatusResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into OrderStatusResponse
            errorMessages.push("Failed to construct OrderStatusResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetOrderStatus200Response` with oneOf schemas ErrorResponse, OrderStatusResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetOrderStatus200Response` with oneOf schemas ErrorResponse, OrderStatusResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetOrderStatus200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOrderStatus200Response} obj Optional instance to populate.
     * @return {module:model/GetOrderStatus200Response} The populated <code>GetOrderStatus200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetOrderStatus200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>OrderStatusResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/OrderStatusResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>OrderStatusResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/OrderStatusResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetOrderStatus200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetOrderStatus200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetOrderStatus200Response} An instance of GetOrderStatus200Response.
     */
    static fromJSON = function(json_string){
        return GetOrderStatus200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 * @member {Number} id
 */
GetOrderStatus200Response.prototype['id'] = undefined;

/**
 * Date and time.
 * @member {String} datetime
 */
GetOrderStatus200Response.prototype['datetime'] = undefined;

/**
 * Type: 0 - buy; 1 - sell.
 * @member {String} type
 */
GetOrderStatus200Response.prototype['type'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetOrderStatus200Response.prototype['status'] = undefined;

/**
 * Market formatted as \"BTC/USD\".
 * @member {String} market
 */
GetOrderStatus200Response.prototype['market'] = undefined;

/**
 * @member {Array.<module:model/OrderTransaction>} transactions
 */
GetOrderStatus200Response.prototype['transactions'] = undefined;

/**
 * Amount remaining.
 * @member {Number} amount_remaining
 */
GetOrderStatus200Response.prototype['amount_remaining'] = undefined;

/**
 * Client order id. (Only returned if order was placed with client order id parameter.).
 * @member {String} client_order_id
 */
GetOrderStatus200Response.prototype['client_order_id'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
GetOrderStatus200Response.prototype['reason'] = undefined;


GetOrderStatus200Response.OneOf = ["ErrorResponse", "OrderStatusResponse"];

export default GetOrderStatus200Response;
