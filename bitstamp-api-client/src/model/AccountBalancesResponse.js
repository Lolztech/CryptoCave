...
/**
 * The AccountBalancesResponse model module.
 * @module model/AccountBalancesResponse
 * @version v2
 */
class AccountBalancesResponse {
    /**
     * Constructs a new <code>AccountBalancesResponse</code>.
     * @alias module:model/AccountBalancesResponse
     */
    constructor() { 
        
        AccountBalancesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountBalancesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountBalancesResponse} obj Optional instance to populate.
     * @return {module:model/AccountBalancesResponse} The populated <code>AccountBalancesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountBalancesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountBalancesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountBalancesResponse</code>.
     */
 ...
 */
AccountBalancesResponse.prototype['available'] = undefined;

/**
 * Currency name.
 * @member {String} currency
 */
AccountBalancesResponse.prototype['currency'] = undefined;

/**
 * Reserved balance for trading.
 * @member {Number} reserved
 */
AccountBalancesResponse.prototype['reserved'] = undefined;

/**
 * Total balance on exchange.
 * @member {Number} total
 */
AccountBalancesResponse.prototype['total'] = undefined;
...
export default AccountBalancesResponse;
