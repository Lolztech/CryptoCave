...
import RetailInfo from './RetailInfo';

/**
 * The ContactSchema model module.
 * @module model/ContactSchema
 * @version v2
 */
class ContactSchema {
    /**
     * Constructs a new <code>ContactSchema</code>.
     * @alias module:model/ContactSchema
     * @param description {String} Alias for your internal usage of the contact
     * @param id {String} Id of the contact
     */
    constructor(description, id) { 
        
        ContactSchema.initialize(this, description, id);
    }
    ...
    /**
     * Constructs a <code>ContactSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactSchema} obj Optional instance to populate.
     * @return {module:model/ContactSchema} The populated <code>ContactSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactSchema();

            if (data.hasOwnProperty('corporate_info')) {
                obj['corporate_info'] = ApiClient.convertToType(data['corporate_info'], CorporateInfo);
            }
            ...
            if (data.hasOwnProperty('retail_info')) {
                obj['retail_info'] = ApiClient.convertToType(data['retail_info'], RetailInfo);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContactSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactSchema</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ContactSchema.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `corporate_info`
        if (data['corporate_info']) { // data not null
          CorporateInfo.validateJSON(data['corporate_info']);
        }
        ...
        // validate the optional field `retail_info`
        if (data['retail_info']) { // data not null
          RetailInfo.validateJSON(data['retail_info']);
        }
...
ContactSchema.RequiredProperties = ["description", "id"];

/**
 * Additional info if the beneficiary is a corporate client
 * @member {module:model/CorporateInfo} corporate_info
 */
ContactSchema.prototype['corporate_info'] = undefined;

/**
 * Alias for your internal usage of the contact
 * @member {String} description
 */
ContactSchema.prototype['description'] = undefined;

/**
 * Id of the contact
 * @member {String} id
 */
ContactSchema.prototype['id'] = undefined;

/**
 * Additional info if the beneficiary is a retail client
 * @member {module:model/RetailInfo} retail_info
 */
ContactSchema.prototype['retail_info'] = undefined;
