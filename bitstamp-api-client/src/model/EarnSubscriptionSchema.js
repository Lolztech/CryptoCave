...
/**
 * The EarnSubscriptionSchema model module.
 * @module model/EarnSubscriptionSchema
 * @version v2
 */
class EarnSubscriptionSchema {
    /**
     * Constructs a new <code>EarnSubscriptionSchema</code>.
     * @alias module:model/EarnSubscriptionSchema
     * @param amount {Number} Amount to subscribe or unsubscribe with.
     * @param currency {String} Currency
     * @param earnTerm {module:model/EarnSubscriptionSchema.EarnTermEnum} Type of Earn term
     * @param earnType {module:model/EarnSubscriptionSchema.EarnTypeEnum} Type of Earn product
     */
    constructor(amount, currency, earnTerm, earnType) { 
        
        EarnSubscriptionSchema.initialize(this, amount, currency, earnTerm, earnType);
    }
     ...
     */
    static initialize(obj, amount, currency, earnTerm, earnType) { 
        obj['amount'] = amount;
        obj['currency'] = currency;
        obj['earn_term'] = earnTerm;
        obj['earn_type'] = earnType;
    }

    /**
     * Constructs a <code>EarnSubscriptionSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EarnSubscriptionSchema} obj Optional instance to populate.
     * @return {module:model/EarnSubscriptionSchema} The populated <code>EarnSubscriptionSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarnSubscriptionSchema();
            ...
            if (data.hasOwnProperty('earn_term')) {
                obj['earn_term'] = ApiClient.convertToType(data['earn_term'], 'String');
            }
            if (data.hasOwnProperty('earn_type')) {
                obj['earn_type'] = ApiClient.convertToType(data['earn_type'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EarnSubscriptionSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarnSubscriptionSchema</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EarnSubscriptionSchema.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['earn_term'] && !(typeof data['earn_term'] === 'string' || data['earn_term'] instanceof String)) {
            throw new Error("Expected the field `earn_term` to be a primitive type in the JSON string but got " + data['earn_term']);
        }
        // ensure the json data is a string
        if (data['earn_type'] && !(typeof data['earn_type'] === 'string' || data['earn_type'] instanceof String)) {
            throw new Error("Expected the field `earn_type` to be a primitive type in the JSON string but got " + data['earn_type']);
        }
...
EarnSubscriptionSchema.RequiredProperties = ["amount", "currency", "earn_term", "earn_type"];

/**
 * Amount to subscribe or unsubscribe with.
 * @member {Number} amount
 */
EarnSubscriptionSchema.prototype['amount'] = undefined;

/**
 * Currency
 * @member {String} currency
 */
EarnSubscriptionSchema.prototype['currency'] = undefined;

/**
 * Type of Earn term
 * @member {module:model/EarnSubscriptionSchema.EarnTermEnum} earn_term
 */
EarnSubscriptionSchema.prototype['earn_term'] = undefined;

/**
 * Type of Earn product
 * @member {module:model/EarnSubscriptionSchema.EarnTypeEnum} earn_type
 */
EarnSubscriptionSchema.prototype['earn_type'] = undefined;
...
/**
 * Allowed values for the <code>earn_term</code> property.
 * @enum {String}
 * @readonly
 */
EarnSubscriptionSchema['EarnTermEnum'] = {
...
/**
 * Allowed values for the <code>earn_type</code> property.
 * @enum {String}
 * @readonly
 */
EarnSubscriptionSchema['EarnTypeEnum'] = {
...
export default EarnSubscriptionSchema;
