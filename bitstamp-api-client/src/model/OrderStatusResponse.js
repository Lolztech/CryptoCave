...
/**
 * The OrderStatusResponse model module.
 * @module model/OrderStatusResponse
 * @version v2
 */
class OrderStatusResponse {
    /**
     * Constructs a new <code>OrderStatusResponse</code>.
     * @alias module:model/OrderStatusResponse
     */
    constructor() { 
        
        OrderStatusResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderStatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderStatusResponse} obj Optional instance to populate.
     * @return {module:model/OrderStatusResponse} The populated <code>OrderStatusResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderStatusResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderStatusResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderStatusResponse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['amount_remaining'] && !(typeof data['amount_remaining'] === 'string' || data['amount_remaining'] instanceof String)) {
            throw new Error("Expected the field `amount_remaining` to be a primitive type in the JSON string but got " + data['amount_remaining']);
        }
        // ensure the json data is a string
 ...
 * @member {Number} id
 */
OrderStatusResponse.prototype['id'] = undefined;

/**
 * Date and time.
 * @member {String} datetime
 */
OrderStatusResponse.prototype['datetime'] = undefined;

/**
 * Type: 0 - buy; 1 - sell.
 * @member {String} type
 */
OrderStatusResponse.prototype['type'] = undefined;

/**
 * Open, Finished, Expired or Canceled.
 * @member {String} status
 */
OrderStatusResponse.prototype['status'] = undefined;

/**
 * Market formatted as \"BTC/USD\".
 * @member {String} market
 */
OrderStatusResponse.prototype['market'] = undefined;

/**
 * @member {Array.<module:model/OrderTransaction>} transactions
 */
OrderStatusResponse.prototype['transactions'] = undefined;

/**
 * Amount remaining.
 * @member {Number} amount_remaining
 */
OrderStatusResponse.prototype['amount_remaining'] = undefined;

/**
 * Client order id. (Only returned if order was placed with client order id parameter.).
 * @member {String} client_order_id
 */
OrderStatusResponse.prototype['client_order_id'] = undefined;
