...
/**
 * The OHLCData model module.
 * @module model/OHLCData
 * @version v2
 */
class OHLCData {
    /**
     * Constructs a new <code>OHLCData</code>.
     * @alias module:model/OHLCData
     */
    constructor() { 
        
        OHLCData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OHLCData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OHLCData} obj Optional instance to populate.
     * @return {module:model/OHLCData} The populated <code>OHLCData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OHLCData();
    ...
    /**
     * Validates the JSON data with respect to <code>OHLCData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OHLCData</code>.
     */
 ...
 */
OHLCData.prototype['timestamp'] = undefined;

/**
 * Opening price.
 * @member {String} open
 */
OHLCData.prototype['open'] = undefined;

/**
 * Price high.
 * @member {String} high
 */
OHLCData.prototype['high'] = undefined;

/**
 * Price low.
 * @member {String} low
 */
OHLCData.prototype['low'] = undefined;

/**
 * Closing price.
 * @member {String} close
 */
OHLCData.prototype['close'] = undefined;

/**
 * Volume.
 * @member {String} volume
 */
OHLCData.prototype['volume'] = undefined;
