...
/**
 * The RetailInfo model module.
 * @module model/RetailInfo
 * @version v2
 */
class RetailInfo {
    /**
     * Constructs a new <code>RetailInfo</code>.
     * @alias module:model/RetailInfo
     */
    constructor() { 
        
        RetailInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RetailInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetailInfo} obj Optional instance to populate.
     * @return {module:model/RetailInfo} The populated <code>RetailInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetailInfo();
            ...
            if (data.hasOwnProperty('street_and_house_number')) {
                obj['street_and_house_number'] = ApiClient.convertToType(data['street_and_house_number'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RetailInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetailInfo</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['street_and_house_number'] && !(typeof data['street_and_house_number'] === 'string' || data['street_and_house_number'] instanceof String)) {
            throw new Error("Expected the field `street_and_house_number` to be a primitive type in the JSON string but got " + data['street_and_house_number']);
        }
        // ensure the json data is a string
 ...
 * @member {String} city
 */
RetailInfo.prototype['city'] = undefined;

/**
 * ISO 3166-1 alpha 2 country code
 * @member {String} country
 */
RetailInfo.prototype['country'] = undefined;

/**
 * @member {Date} date_of_birth
 */
RetailInfo.prototype['date_of_birth'] = undefined;

/**
 * First name of the contact
 * @member {String} first_name
 */
RetailInfo.prototype['first_name'] = undefined;

/**
 * Last name of the contact
 * @member {String} last_name
 */
RetailInfo.prototype['last_name'] = undefined;

/**
 * @member {String} street_and_house_number
 */
RetailInfo.prototype['street_and_house_number'] = undefined;

/**
 * @member {String} zip
 */
RetailInfo.prototype['zip'] = undefined;
