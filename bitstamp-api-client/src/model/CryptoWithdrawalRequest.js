...
/**
 * The CryptoWithdrawalRequest model module.
 * @module model/CryptoWithdrawalRequest
 * @version v2
 */
class CryptoWithdrawalRequest {
    /**
     * Constructs a new <code>CryptoWithdrawalRequest</code>.
     * @alias module:model/CryptoWithdrawalRequest
     * @param address {String} Cryptocurrency address.
     * @param amount {Number} Cryptocurrency amount.
     * @param destinationTag {String} Address destination tag - applicable to: XRP.
     */
    constructor(address, amount, destinationTag) { 
        
        CryptoWithdrawalRequest.initialize(this, address, amount, destinationTag);
    }
     ...
     */
    static initialize(obj, address, amount, destinationTag) { 
        obj['address'] = address;
        obj['amount'] = amount;
        obj['destination_tag'] = destinationTag;
    }

    /**
     * Constructs a <code>CryptoWithdrawalRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CryptoWithdrawalRequest} obj Optional instance to populate.
     * @return {module:model/CryptoWithdrawalRequest} The populated <code>CryptoWithdrawalRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CryptoWithdrawalRequest();
            ...
            if (data.hasOwnProperty('contact_thirdparty')) {
                obj['contact_thirdparty'] = ApiClient.convertToType(data['contact_thirdparty'], 'Boolean');
            }
            if (data.hasOwnProperty('contact_uuid')) {
                obj['contact_uuid'] = ApiClient.convertToType(data['contact_uuid'], 'String');
            }
            if (data.hasOwnProperty('destination_tag')) {
                obj['destination_tag'] = ApiClient.convertToType(data['destination_tag'], 'String');
            }
            if (data.hasOwnProperty('memo_id')) {
                obj['memo_id'] = ApiClient.convertToType(data['memo_id'], 'String');
            }
            if (data.hasOwnProperty('network')) {
                obj['network'] = ApiClient.convertToType(data['network'], 'String');
            }
            if (data.hasOwnProperty('transfer_id')) {
                obj['transfer_id'] = ApiClient.convertToType(data['transfer_id'], 'Number');
            }
            if (data.hasOwnProperty('vasp_uuid')) {
                obj['vasp_uuid'] = ApiClient.convertToType(data['vasp_uuid'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CryptoWithdrawalRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CryptoWithdrawalRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CryptoWithdrawalRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['contact_uuid'] && !(typeof data['contact_uuid'] === 'string' || data['contact_uuid'] instanceof String)) {
            throw new Error("Expected the field `contact_uuid` to be a primitive type in the JSON string but got " + data['contact_uuid']);
        }
        // ensure the json data is a string
        if (data['destination_tag'] && !(typeof data['destination_tag'] === 'string' || data['destination_tag'] instanceof String)) {
            throw new Error("Expected the field `destination_tag` to be a primitive type in the JSON string but got " + data['destination_tag']);
        }
        // ensure the json data is a string
        if (data['memo_id'] && !(typeof data['memo_id'] === 'string' || data['memo_id'] instanceof String)) {
            throw new Error("Expected the field `memo_id` to be a primitive type in the JSON string but got " + data['memo_id']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['vasp_uuid'] && !(typeof data['vasp_uuid'] === 'string' || data['vasp_uuid'] instanceof String)) {
            throw new Error("Expected the field `vasp_uuid` to be a primitive type in the JSON string but got " + data['vasp_uuid']);
        }
...
CryptoWithdrawalRequest.RequiredProperties = ["address", "amount", "destination_tag"];

/**
 * Cryptocurrency address.
 * @member {String} address
 */
CryptoWithdrawalRequest.prototype['address'] = undefined;

/**
 * Cryptocurrency amount.
 * @member {Number} amount
 */
CryptoWithdrawalRequest.prototype['amount'] = undefined;
 ...
 * @member {Boolean} contact_thirdparty
 */
CryptoWithdrawalRequest.prototype['contact_thirdparty'] = undefined;
 ...
 * @member {String} contact_uuid
 */
CryptoWithdrawalRequest.prototype['contact_uuid'] = undefined;

/**
 * Address destination tag - applicable to: XRP.
 * @member {String} destination_tag
 */
CryptoWithdrawalRequest.prototype['destination_tag'] = undefined;

/**
 * Address memo id - applicable to: XLM, HBAR.
 * @member {String} memo_id
 */
CryptoWithdrawalRequest.prototype['memo_id'] = undefined;

/**
 * Cryptocurrency network.
 * @member {module:model/CryptoWithdrawalRequest.NetworkEnum} network
 */
CryptoWithdrawalRequest.prototype['network'] = undefined;

/**
 * Address transfer id - applicable to: CSPR.
 * @member {Number} transfer_id
 */
CryptoWithdrawalRequest.prototype['transfer_id'] = undefined;
 ...
 * @member {String} vasp_uuid
 */
CryptoWithdrawalRequest.prototype['vasp_uuid'] = undefined;
 ...
 * @readonly
 */
CryptoWithdrawalRequest['NetworkEnum'] = {
...
export default CryptoWithdrawalRequest;
