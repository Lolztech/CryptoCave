...
/**
 * The FeeWithdrawalRequest model module.
 * @module model/FeeWithdrawalRequest
 * @version v2
 */
class FeeWithdrawalRequest {
    /**
     * Constructs a new <code>FeeWithdrawalRequest</code>.
     * @alias module:model/FeeWithdrawalRequest
     */
    constructor() { 
        
        FeeWithdrawalRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FeeWithdrawalRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeeWithdrawalRequest} obj Optional instance to populate.
     * @return {module:model/FeeWithdrawalRequest} The populated <code>FeeWithdrawalRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeeWithdrawalRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>FeeWithdrawalRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeeWithdrawalRequest</code>.
     */
 ...
 * @member {module:model/FeeWithdrawalRequest.NetworkEnum} network
 */
FeeWithdrawalRequest.prototype['network'] = undefined;
 ...
 * @readonly
 */
FeeWithdrawalRequest['NetworkEnum'] = {
...
export default FeeWithdrawalRequest;
