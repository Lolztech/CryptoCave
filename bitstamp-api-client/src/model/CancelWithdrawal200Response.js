...
import CancelBankWithdrawalResponse from './CancelBankWithdrawalResponse';
import ErrorResponse from './ErrorResponse';

/**
 * The CancelWithdrawal200Response model module.
 * @module model/CancelWithdrawal200Response
 * @version v2
 */
class CancelWithdrawal200Response {
    /**
     * Constructs a new <code>CancelWithdrawal200Response</code>.
     * @alias module:model/CancelWithdrawal200Response
     * @param {(module:model/CancelBankWithdrawalResponse|module:model/ErrorResponse)} instance The actual instance to initialize CancelWithdrawal200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "CancelBankWithdrawalResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CancelBankWithdrawalResponse.validateJSON(instance); // throw an exception if no match
                // create CancelBankWithdrawalResponse from JS object
                this.actualInstance = CancelBankWithdrawalResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CancelBankWithdrawalResponse
            errorMessages.push("Failed to construct CancelBankWithdrawalResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `CancelWithdrawal200Response` with oneOf schemas CancelBankWithdrawalResponse, ErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `CancelWithdrawal200Response` with oneOf schemas CancelBankWithdrawalResponse, ErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>CancelWithdrawal200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelWithdrawal200Response} obj Optional instance to populate.
     * @return {module:model/CancelWithdrawal200Response} The populated <code>CancelWithdrawal200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new CancelWithdrawal200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>CancelBankWithdrawalResponse</code>, <code>ErrorResponse</code>.
     * @return {(module:model/CancelBankWithdrawalResponse|module:model/ErrorResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CancelBankWithdrawalResponse</code>, <code>ErrorResponse</code>.
     * @param {(module:model/CancelBankWithdrawalResponse|module:model/ErrorResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = CancelWithdrawal200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of CancelWithdrawal200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/CancelWithdrawal200Response} An instance of CancelWithdrawal200Response.
     */
    static fromJSON = function(json_string){
        return CancelWithdrawal200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
CancelWithdrawal200Response.prototype['account_currency'] = undefined;

/**
 * Amount of the cancelled withdrawal request.
 * @member {Number} amount
 */
CancelWithdrawal200Response.prototype['amount'] = undefined;

/**
 * Currency of the cancelled withdrawal request.
 * @member {String} currency
 */
CancelWithdrawal200Response.prototype['currency'] = undefined;

/**
 * ID of the cancelled withdrawal request.
 * @member {String} id
 */
CancelWithdrawal200Response.prototype['id'] = undefined;

/**
 * The type of the cancelled withdrawal request.
 * @member {String} type
 */
CancelWithdrawal200Response.prototype['type'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
CancelWithdrawal200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
CancelWithdrawal200Response.prototype['status'] = undefined;


CancelWithdrawal200Response.OneOf = ["CancelBankWithdrawalResponse", "ErrorResponse"];

export default CancelWithdrawal200Response;
