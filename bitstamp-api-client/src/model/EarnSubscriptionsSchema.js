...
/**
 * The EarnSubscriptionsSchema model module.
 * @module model/EarnSubscriptionsSchema
 * @version v2
 */
class EarnSubscriptionsSchema {
    /**
     * Constructs a new <code>EarnSubscriptionsSchema</code>.
     * @alias module:model/EarnSubscriptionsSchema
     */
    constructor() { 
        
        EarnSubscriptionsSchema.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EarnSubscriptionsSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EarnSubscriptionsSchema} obj Optional instance to populate.
     * @return {module:model/EarnSubscriptionsSchema} The populated <code>EarnSubscriptionsSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarnSubscriptionsSchema();

            if (data.hasOwnProperty('activation_period')) {
                obj['activation_period'] = ApiClient.convertToType(data['activation_period'], 'String');
            }
            ...
            if (data.hasOwnProperty('available_amount')) {
                obj['available_amount'] = ApiClient.convertToType(data['available_amount'], 'Number');
            }
            if (data.hasOwnProperty('currency')) {
                obj['currency'] = ApiClient.convertToType(data['currency'], 'String');
            }
            if (data.hasOwnProperty('distribution_period')) {
                obj['distribution_period'] = ApiClient.convertToType(data['distribution_period'], 'String');
            }
            if (data.hasOwnProperty('estimated_annual_yield')) {
                obj['estimated_annual_yield'] = ApiClient.convertToType(data['estimated_annual_yield'], 'Number');
            }
            if (data.hasOwnProperty('minimum_subscription_amount')) {
                obj['minimum_subscription_amount'] = ApiClient.convertToType(data['minimum_subscription_amount'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EarnSubscriptionsSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarnSubscriptionsSchema</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['activation_period'] && !(typeof data['activation_period'] === 'string' || data['activation_period'] instanceof String)) {
            throw new Error("Expected the field `activation_period` to be a primitive type in the JSON string but got " + data['activation_period']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['distribution_period'] && !(typeof data['distribution_period'] === 'string' || data['distribution_period'] instanceof String)) {
            throw new Error("Expected the field `distribution_period` to be a primitive type in the JSON string but got " + data['distribution_period']);
        }
        // ensure the json data is a string
 ...
 * @member {String} activation_period
 */
EarnSubscriptionsSchema.prototype['activation_period'] = undefined;

/**
 * Amount on which you are earning interest
 * @member {Number} amount
 */
EarnSubscriptionsSchema.prototype['amount'] = undefined;

/**
 * Amount that has been earned
 * @member {Number} amount_earned
 */
EarnSubscriptionsSchema.prototype['amount_earned'] = undefined;

/**
 * Amount on which you are earning interest that is available to withdraw from Earn
 * @member {Number} available_amount
 */
EarnSubscriptionsSchema.prototype['available_amount'] = undefined;

/**
 * Currency
 * @member {String} currency
 */
EarnSubscriptionsSchema.prototype['currency'] = undefined;

/**
 * Period in which the rewards are distributed
 * @member {module:model/EarnSubscriptionsSchema.DistributionPeriodEnum} distribution_period
 */
EarnSubscriptionsSchema.prototype['distribution_period'] = undefined;

/**
 * Estimated annual yield
 * @member {Number} estimated_annual_yield
 */
EarnSubscriptionsSchema.prototype['estimated_annual_yield'] = undefined;

/**
 * Minimum amount for subscription
 * @member {Number} minimum_subscription_amount
 */
EarnSubscriptionsSchema.prototype['minimum_subscription_amount'] = undefined;

/**
 * Type of Earn term
 * @member {module:model/EarnSubscriptionsSchema.TermEnum} term
 */
EarnSubscriptionsSchema.prototype['term'] = undefined;

/**
 * Type of Earn product
 * @member {module:model/EarnSubscriptionsSchema.TypeEnum} type
 */
EarnSubscriptionsSchema.prototype['type'] = undefined;
...
/**
 * Allowed values for the <code>distribution_period</code> property.
 * @enum {String}
 * @readonly
 */
EarnSubscriptionsSchema['DistributionPeriodEnum'] = {
...
/**
 * Allowed values for the <code>term</code> property.
 * @enum {String}
 * @readonly
 */
EarnSubscriptionsSchema['TermEnum'] = {
 ...
 * @readonly
 */
EarnSubscriptionsSchema['TypeEnum'] = {
...
export default EarnSubscriptionsSchema;
