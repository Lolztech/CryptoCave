...
/**
 * The CancelBankWithdrawalResponse model module.
 * @module model/CancelBankWithdrawalResponse
 * @version v2
 */
class CancelBankWithdrawalResponse {
    /**
     * Constructs a new <code>CancelBankWithdrawalResponse</code>.
     * @alias module:model/CancelBankWithdrawalResponse
     */
    constructor() { 
        
        CancelBankWithdrawalResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CancelBankWithdrawalResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelBankWithdrawalResponse} obj Optional instance to populate.
     * @return {module:model/CancelBankWithdrawalResponse} The populated <code>CancelBankWithdrawalResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelBankWithdrawalResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelBankWithdrawalResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelBankWithdrawalResponse</code>.
     */
 ...
 */
CancelBankWithdrawalResponse.prototype['account_currency'] = undefined;

/**
 * Amount of the cancelled withdrawal request.
 * @member {Number} amount
 */
CancelBankWithdrawalResponse.prototype['amount'] = undefined;

/**
 * Currency of the cancelled withdrawal request.
 * @member {String} currency
 */
CancelBankWithdrawalResponse.prototype['currency'] = undefined;

/**
 * ID of the cancelled withdrawal request.
 * @member {String} id
 */
CancelBankWithdrawalResponse.prototype['id'] = undefined;

/**
 * The type of the cancelled withdrawal request.
 * @member {String} type
 */
CancelBankWithdrawalResponse.prototype['type'] = undefined;
...
export default CancelBankWithdrawalResponse;
