...
/**
 * The TickerHourResponse model module.
 * @module model/TickerHourResponse
 * @version v2
 */
class TickerHourResponse {
    /**
     * Constructs a new <code>TickerHourResponse</code>.
     * @alias module:model/TickerHourResponse
     */
    constructor() { 
        
        TickerHourResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TickerHourResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TickerHourResponse} obj Optional instance to populate.
     * @return {module:model/TickerHourResponse} The populated <code>TickerHourResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TickerHourResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>TickerHourResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TickerHourResponse</code>.
     */
 ...
 * @member {String} ask
 */
TickerHourResponse.prototype['ask'] = undefined;

/**
 * Highest buy order.
 * @member {String} bid
 */
TickerHourResponse.prototype['bid'] = undefined;

/**
 * Last hour price high.
 * @member {String} high
 */
TickerHourResponse.prototype['high'] = undefined;

/**
 * Last price.
 * @member {String} last
 */
TickerHourResponse.prototype['last'] = undefined;

/**
 * Last hour price low.
 * @member {String} low
 */
TickerHourResponse.prototype['low'] = undefined;

/**
 * First price of the hour.
 * @member {String} open
 */
TickerHourResponse.prototype['open'] = undefined;

/**
 * Ticker side: 0 - buy; 1 - sell.
 * @member {String} side
 */
TickerHourResponse.prototype['side'] = undefined;

/**
 * Unix timestamp date and time.
 * @member {String} timestamp
 */
TickerHourResponse.prototype['timestamp'] = undefined;

/**
 * Last hour volume.
 * @member {String} volume
 */
TickerHourResponse.prototype['volume'] = undefined;

/**
 * Last hour volume weighted average price.
 * @member {String} vwap
 */
TickerHourResponse.prototype['vwap'] = undefined;
...
export default TickerHourResponse;
