...
/**
 * The WithdrawalRequestsRequest model module.
 * @module model/WithdrawalRequestsRequest
 * @version v2
 */
class WithdrawalRequestsRequest {
    /**
     * Constructs a new <code>WithdrawalRequestsRequest</code>.
     * @alias module:model/WithdrawalRequestsRequest
     */
    constructor() { 
        
        WithdrawalRequestsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WithdrawalRequestsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithdrawalRequestsRequest} obj Optional instance to populate.
     * @return {module:model/WithdrawalRequestsRequest} The populated <code>WithdrawalRequestsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithdrawalRequestsRequest();
            ...
            if (data.hasOwnProperty('timedelta')) {
                obj['timedelta'] = ApiClient.convertToType(data['timedelta'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WithdrawalRequestsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WithdrawalRequestsRequest</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['timedelta'] && !(typeof data['timedelta'] === 'string' || data['timedelta'] instanceof String)) {
            throw new Error("Expected the field `timedelta` to be a primitive type in the JSON string but got " + data['timedelta']);
        }
...
export default WithdrawalRequestsRequest;
