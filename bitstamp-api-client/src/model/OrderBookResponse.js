...
class OrderBookResponse {
    ...
    constructor() { 
        ...
        OrderBookResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('microtimestamp')) {
                obj['microtimestamp'] = ApiClient.convertToType(data['microtimestamp'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderBookResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderBookResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['microtimestamp'] && !(typeof data['microtimestamp'] === 'string' || data['microtimestamp'] instanceof String)) {
            throw new Error("Expected the field `microtimestamp` to be a primitive type in the JSON string but got " + data['microtimestamp']);
        }
        // ensure the json data is a string
 ...
 */
OrderBookResponse.prototype['asks'] = undefined;

/**
 * List of buy orders.
 * @member {Array.<Array.<String>>} bids
 */
OrderBookResponse.prototype['bids'] = undefined;

/**
 * Unix timestamp date and time in microseconds.
 * @member {String} microtimestamp
 */
OrderBookResponse.prototype['microtimestamp'] = undefined;

/**
 * Unix timestamp date and time.
 * @member {String} timestamp
 */
OrderBookResponse.prototype['timestamp'] = undefined;
...
export default OrderBookResponse;
