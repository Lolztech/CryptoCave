...
/**
 * The UserTransactionsResponse model module.
 * @module model/UserTransactionsResponse
 * @version v2
 */
class UserTransactionsResponse {
    /**
     * Constructs a new <code>UserTransactionsResponse</code>.
     * @alias module:model/UserTransactionsResponse
     */
    constructor() { 
        
        UserTransactionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserTransactionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserTransactionsResponse} obj Optional instance to populate.
     * @return {module:model/UserTransactionsResponse} The populated <code>UserTransactionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserTransactionsResponse();
            ...
            if (data.hasOwnProperty('self_trade_order_id')) {
                obj['self_trade_order_id'] = ApiClient.convertToType(data['self_trade_order_id'], 'Number');
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = ApiClient.convertToType(data['type'], 'String');
            }
            if (data.hasOwnProperty('{currency_pair}')) {
                obj['{currency_pair}'] = ApiClient.convertToType(data['{currency_pair}'], 'Number');
            }
            if (data.hasOwnProperty('{from_currency}')) {
                obj['{from_currency}'] = ApiClient.convertToType(data['{from_currency}'], 'String');
            }
            if (data.hasOwnProperty('{to_currency}')) {
                obj['{to_currency}'] = ApiClient.convertToType(data['{to_currency}'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserTransactionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserTransactionsResponse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['{from_currency}'] && !(typeof data['{from_currency}'] === 'string' || data['{from_currency}'] instanceof String)) {
            throw new Error("Expected the field `{from_currency}` to be a primitive type in the JSON string but got " + data['{from_currency}']);
        }
        // ensure the json data is a string
        if (data['{to_currency}'] && !(typeof data['{to_currency}'] === 'string' || data['{to_currency}'] instanceof String)) {
            throw new Error("Expected the field `{to_currency}` to be a primitive type in the JSON string but got " + data['{to_currency}']);
        }
 ...
 */
UserTransactionsResponse.prototype['datetime'] = undefined;

/**
 * Transaction fee.
 * @member {String} fee
 */
UserTransactionsResponse.prototype['fee'] = undefined;

/**
 * Transaction ID.
 * @member {Number} id
 */
UserTransactionsResponse.prototype['id'] = undefined;

/**
 * Executed order ID.
 * @member {Number} order_id
 */
UserTransactionsResponse.prototype['order_id'] = undefined;

/**
 * True if transaction is a self trade transaction.
 * @member {Boolean} self_trade
 */
UserTransactionsResponse.prototype['self_trade'] = undefined;

/**
 * Order ID of the complementary order of the self trade.
 * @member {Number} self_trade_order_id
 */
UserTransactionsResponse.prototype['self_trade_order_id'] = undefined;

/**
 * Transaction type: 0 - deposit; 1 - withdrawal; 2 - market trade; 14 - sub account transfer; 25 - credited with staked assets; 26 - sent assets to staking; 27 - staking reward; 32 - referral reward; 35 - inter account transfer; 33 - settlement transfer.
 * @member {String} type
 */
UserTransactionsResponse.prototype['type'] = undefined;

/**
 * {currency_pair} exchange rate.
 * @member {Number} {currency_pair}
 */
UserTransactionsResponse.prototype['{currency_pair}'] = undefined;

/**
 * {from_currency} amount.
 * @member {String} {from_currency}
 */
UserTransactionsResponse.prototype['{from_currency}'] = undefined;

/**
 * {to_currency} amount.
 * @member {String} {to_currency}
 */
UserTransactionsResponse.prototype['{to_currency}'] = undefined;
...
export default UserTransactionsResponse;
