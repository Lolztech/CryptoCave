...
/**
 * The WithdrawalRequestsResponse model module.
 * @module model/WithdrawalRequestsResponse
 * @version v2
 */
class WithdrawalRequestsResponse {
    /**
     * Constructs a new <code>WithdrawalRequestsResponse</code>.
     * @alias module:model/WithdrawalRequestsResponse
     */
    constructor() { 
        
        WithdrawalRequestsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WithdrawalRequestsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithdrawalRequestsResponse} obj Optional instance to populate.
     * @return {module:model/WithdrawalRequestsResponse} The populated <code>WithdrawalRequestsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithdrawalRequestsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>WithdrawalRequestsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WithdrawalRequestsResponse</code>.
     */
 ...
 */
WithdrawalRequestsResponse.prototype['address'] = undefined;

/**
 * Amount.
 * @member {String} amount
 */
WithdrawalRequestsResponse.prototype['amount'] = undefined;

/**
 * Currency.
 * @member {String} currency
 */
WithdrawalRequestsResponse.prototype['currency'] = undefined;

/**
 * Date and time.
 * @member {Date} datetime
 */
WithdrawalRequestsResponse.prototype['datetime'] = undefined;

/**
 * Withdrawal ID.
 * @member {Number} id
 */
WithdrawalRequestsResponse.prototype['id'] = undefined;

/**
 * Cryptocurrency network.
 * @member {module:model/WithdrawalRequestsResponse.NetworkEnum} network
 */
WithdrawalRequestsResponse.prototype['network'] = undefined;

/**
 * 0 (open), 1 (in process), 2 (finished), 3 (canceled), 4 (failed) or 11 (reversed).
 * @member {Number} status
 */
WithdrawalRequestsResponse.prototype['status'] = undefined;

/**
 * Transaction ID (crypto withdrawals only).
 * @member {String} transaction_id
 */
WithdrawalRequestsResponse.prototype['transaction_id'] = undefined;

/**
 * Bitstamp's transaction id.
 * @member {Number} txid
 */
WithdrawalRequestsResponse.prototype['txid'] = undefined;
 ...
 * @member {Number} type
 */
WithdrawalRequestsResponse.prototype['type'] = undefined;
 ...
 * @readonly
 */
WithdrawalRequestsResponse['NetworkEnum'] = {
...
export default WithdrawalRequestsResponse;
