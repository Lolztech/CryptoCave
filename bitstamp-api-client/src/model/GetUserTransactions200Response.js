...
import UserTransactionsResponse from './UserTransactionsResponse';

/**
 * The GetUserTransactions200Response model module.
 * @module model/GetUserTransactions200Response
 * @version v2
 */
class GetUserTransactions200Response {
    /**
     * Constructs a new <code>GetUserTransactions200Response</code>.
     * @alias module:model/GetUserTransactions200Response
     * @param {(module:model/ErrorResponse|module:model/[UserTransactionsResponse])} instance The actual instance to initialize GetUserTransactions200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "[UserTransactionsResponse]") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                [UserTransactionsResponse].validateJSON(instance); // throw an exception if no match
                // create [UserTransactionsResponse] from JS object
                this.actualInstance = [UserTransactionsResponse].constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into [UserTransactionsResponse]
            errorMessages.push("Failed to construct [UserTransactionsResponse]: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetUserTransactions200Response` with oneOf schemas ErrorResponse, [UserTransactionsResponse]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetUserTransactions200Response` with oneOf schemas ErrorResponse, [UserTransactionsResponse]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetUserTransactions200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserTransactions200Response} obj Optional instance to populate.
     * @return {module:model/GetUserTransactions200Response} The populated <code>GetUserTransactions200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetUserTransactions200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>[UserTransactionsResponse]</code>.
     * @return {(module:model/ErrorResponse|module:model/[UserTransactionsResponse])} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>[UserTransactionsResponse]</code>.
     * @param {(module:model/ErrorResponse|module:model/[UserTransactionsResponse])} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetUserTransactions200Response.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/GetUserTransactions200Response} An instance of GetUserTransactions200Response.
     */
    static fromJSON = function(json_string){
        return GetUserTransactions200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetUserTransactions200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetUserTransactions200Response.prototype['status'] = undefined;


GetUserTransactions200Response.OneOf = ["ErrorResponse", "[UserTransactionsResponse]"];

export default GetUserTransactions200Response;
