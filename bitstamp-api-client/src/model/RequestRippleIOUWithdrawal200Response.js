...
import RippleIOUWithdrawalResponse from './RippleIOUWithdrawalResponse';

/**
 * The RequestRippleIOUWithdrawal200Response model module.
 * @module model/RequestRippleIOUWithdrawal200Response
 * @version v2
 */
class RequestRippleIOUWithdrawal200Response {
    /**
     * Constructs a new <code>RequestRippleIOUWithdrawal200Response</code>.
     * @alias module:model/RequestRippleIOUWithdrawal200Response
     * @param {(module:model/ErrorResponse|module:model/RippleIOUWithdrawalResponse)} instance The actual instance to initialize RequestRippleIOUWithdrawal200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "RippleIOUWithdrawalResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                RippleIOUWithdrawalResponse.validateJSON(instance); // throw an exception if no match
                // create RippleIOUWithdrawalResponse from JS object
                this.actualInstance = RippleIOUWithdrawalResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into RippleIOUWithdrawalResponse
            errorMessages.push("Failed to construct RippleIOUWithdrawalResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `RequestRippleIOUWithdrawal200Response` with oneOf schemas ErrorResponse, RippleIOUWithdrawalResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `RequestRippleIOUWithdrawal200Response` with oneOf schemas ErrorResponse, RippleIOUWithdrawalResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>RequestRippleIOUWithdrawal200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestRippleIOUWithdrawal200Response} obj Optional instance to populate.
     * @return {module:model/RequestRippleIOUWithdrawal200Response} The populated <code>RequestRippleIOUWithdrawal200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new RequestRippleIOUWithdrawal200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>RippleIOUWithdrawalResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/RippleIOUWithdrawalResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>RippleIOUWithdrawalResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/RippleIOUWithdrawalResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = RequestRippleIOUWithdrawal200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of RequestRippleIOUWithdrawal200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/RequestRippleIOUWithdrawal200Response} An instance of RequestRippleIOUWithdrawal200Response.
     */
    static fromJSON = function(json_string){
        return RequestRippleIOUWithdrawal200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 * @member {Number} id
 */
RequestRippleIOUWithdrawal200Response.prototype['id'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
RequestRippleIOUWithdrawal200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
RequestRippleIOUWithdrawal200Response.prototype['status'] = undefined;


RequestRippleIOUWithdrawal200Response.OneOf = ["ErrorResponse", "RippleIOUWithdrawalResponse"];

export default RequestRippleIOUWithdrawal200Response;
