...
/**
 * The OpenOrdersPairResponse model module.
 * @module model/OpenOrdersPairResponse
 * @version v2
 */
class OpenOrdersPairResponse {
    /**
     * Constructs a new <code>OpenOrdersPairResponse</code>.
     * @alias module:model/OpenOrdersPairResponse
     */
    constructor() { 
        
        OpenOrdersPairResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpenOrdersPairResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenOrdersPairResponse} obj Optional instance to populate.
     * @return {module:model/OpenOrdersPairResponse} The populated <code>OpenOrdersPairResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenOrdersPairResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>OpenOrdersPairResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpenOrdersPairResponse</code>.
     */
 ...
 * @member {String} id
 */
OpenOrdersPairResponse.prototype['id'] = undefined;

/**
 * Date and time.
 * @member {String} datetime
 */
OpenOrdersPairResponse.prototype['datetime'] = undefined;

/**
 * Order type: 0 - buy; 1 - sell.
 * @member {String} type
 */
OpenOrdersPairResponse.prototype['type'] = undefined;

/**
 * Price.
 * @member {String} price
 */
OpenOrdersPairResponse.prototype['price'] = undefined;

/**
 * Remaining amount.
 * @member {String} amount
 */
OpenOrdersPairResponse.prototype['amount'] = undefined;

/**
 * Initial amount.
 * @member {String} amount_at_create
 */
OpenOrdersPairResponse.prototype['amount_at_create'] = undefined;

/**
 * Market formatted as \"BTC/USD\".
 * @member {String} market
 */
OpenOrdersPairResponse.prototype['market'] = undefined;

/**
 * Limit price. (Only returned if limit order was placed with limit_price parameter.)
 * @member {String} limit_price
 */
OpenOrdersPairResponse.prototype['limit_price'] = undefined;

/**
 * Client order id. (Only returned if order was placed with client order id parameter.)
 * @member {String} client_order_id
 */
OpenOrdersPairResponse.prototype['client_order_id'] = undefined;
...
export default OpenOrdersPairResponse;
