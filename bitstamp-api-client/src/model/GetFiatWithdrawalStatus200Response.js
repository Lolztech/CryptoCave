...
import BankWithdrawalStatusResponse from './BankWithdrawalStatusResponse';
import ErrorResponse from './ErrorResponse';

/**
 * The GetFiatWithdrawalStatus200Response model module.
 * @module model/GetFiatWithdrawalStatus200Response
 * @version v2
 */
class GetFiatWithdrawalStatus200Response {
    /**
     * Constructs a new <code>GetFiatWithdrawalStatus200Response</code>.
     * @alias module:model/GetFiatWithdrawalStatus200Response
     * @param {(module:model/BankWithdrawalStatusResponse|module:model/ErrorResponse)} instance The actual instance to initialize GetFiatWithdrawalStatus200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "BankWithdrawalStatusResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                BankWithdrawalStatusResponse.validateJSON(instance); // throw an exception if no match
                // create BankWithdrawalStatusResponse from JS object
                this.actualInstance = BankWithdrawalStatusResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into BankWithdrawalStatusResponse
            errorMessages.push("Failed to construct BankWithdrawalStatusResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetFiatWithdrawalStatus200Response` with oneOf schemas BankWithdrawalStatusResponse, ErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetFiatWithdrawalStatus200Response` with oneOf schemas BankWithdrawalStatusResponse, ErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetFiatWithdrawalStatus200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFiatWithdrawalStatus200Response} obj Optional instance to populate.
     * @return {module:model/GetFiatWithdrawalStatus200Response} The populated <code>GetFiatWithdrawalStatus200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetFiatWithdrawalStatus200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>BankWithdrawalStatusResponse</code>, <code>ErrorResponse</code>.
     * @return {(module:model/BankWithdrawalStatusResponse|module:model/ErrorResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>BankWithdrawalStatusResponse</code>, <code>ErrorResponse</code>.
     * @param {(module:model/BankWithdrawalStatusResponse|module:model/ErrorResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetFiatWithdrawalStatus200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetFiatWithdrawalStatus200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetFiatWithdrawalStatus200Response} An instance of GetFiatWithdrawalStatus200Response.
     */
    static fromJSON = function(json_string){
        return GetFiatWithdrawalStatus200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetFiatWithdrawalStatus200Response.prototype['status'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
GetFiatWithdrawalStatus200Response.prototype['reason'] = undefined;


GetFiatWithdrawalStatus200Response.OneOf = ["BankWithdrawalStatusResponse", "ErrorResponse"];

export default GetFiatWithdrawalStatus200Response;
