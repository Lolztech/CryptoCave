...
/**
 * The EarnSubscriptionSettingSchema model module.
 * @module model/EarnSubscriptionSettingSchema
 * @version v2
 */
class EarnSubscriptionSettingSchema {
    /**
     * Constructs a new <code>EarnSubscriptionSettingSchema</code>.
     * @alias module:model/EarnSubscriptionSettingSchema
     * @param currency {String} Currency
     * @param earnType {module:model/EarnSubscriptionSettingSchema.EarnTypeEnum} Type of Earn product
     * @param setting {module:model/EarnSubscriptionSettingSchema.SettingEnum} Type of setting action.
     */
    constructor(currency, earnType, setting) { 
        
        EarnSubscriptionSettingSchema.initialize(this, currency, earnType, setting);
    }
     ...
     */
    static initialize(obj, currency, earnType, setting) { 
    ...
    /**
     * Constructs a <code>EarnSubscriptionSettingSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EarnSubscriptionSettingSchema} obj Optional instance to populate.
     * @return {module:model/EarnSubscriptionSettingSchema} The populated <code>EarnSubscriptionSettingSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarnSubscriptionSettingSchema();
    ...
    /**
     * Validates the JSON data with respect to <code>EarnSubscriptionSettingSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarnSubscriptionSettingSchema</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EarnSubscriptionSettingSchema.RequiredProperties) {
...
EarnSubscriptionSettingSchema.RequiredProperties = ["currency", "earn_type", "setting"];

/**
 * Currency
 * @member {String} currency
 */
EarnSubscriptionSettingSchema.prototype['currency'] = undefined;

/**
 * Type of Earn product
 * @member {module:model/EarnSubscriptionSettingSchema.EarnTypeEnum} earn_type
 */
EarnSubscriptionSettingSchema.prototype['earn_type'] = undefined;

/**
 * Type of setting action.
 * @member {module:model/EarnSubscriptionSettingSchema.SettingEnum} setting
 */
EarnSubscriptionSettingSchema.prototype['setting'] = undefined;
 ...
 * @readonly
 */
EarnSubscriptionSettingSchema['EarnTypeEnum'] = {
...
/**
 * Allowed values for the <code>setting</code> property.
 * @enum {String}
 * @readonly
 */
EarnSubscriptionSettingSchema['SettingEnum'] = {
...
export default EarnSubscriptionSettingSchema;
