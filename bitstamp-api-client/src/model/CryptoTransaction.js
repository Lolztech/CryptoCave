...
/**
 * The CryptoTransaction model module.
 * @module model/CryptoTransaction
 * @version v2
 */
class CryptoTransaction {
    /**
     * Constructs a new <code>CryptoTransaction</code>.
     * @alias module:model/CryptoTransaction
     */
    constructor() { 
        
        CryptoTransaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CryptoTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CryptoTransaction} obj Optional instance to populate.
     * @return {module:model/CryptoTransaction} The populated <code>CryptoTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CryptoTransaction();
    ...
    /**
     * Validates the JSON data with respect to <code>CryptoTransaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CryptoTransaction</code>.
     */
 ...
 */
CryptoTransaction.prototype['amount'] = undefined;

/**
 * Currency.
 * @member {String} currency
 */
CryptoTransaction.prototype['currency'] = undefined;

/**
 * Date and time.
 * @member {Number} datetime
 */
CryptoTransaction.prototype['datetime'] = undefined;

/**
 * Destination address.
 * @member {String} destinationAddress
 */
CryptoTransaction.prototype['destinationAddress'] = undefined;

/**
 * Cryptocurrency network.
 * @member {module:model/CryptoTransaction.NetworkEnum} network
 */
CryptoTransaction.prototype['network'] = undefined;

/**
 * Transaction hash.
 * @member {String} txid
 */
CryptoTransaction.prototype['txid'] = undefined;
