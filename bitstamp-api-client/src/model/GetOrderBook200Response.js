...
import OrderBookResponse from './OrderBookResponse';

/**
 * The GetOrderBook200Response model module.
 * @module model/GetOrderBook200Response
 * @version v2
 */
class GetOrderBook200Response {
    /**
     * Constructs a new <code>GetOrderBook200Response</code>.
     * @alias module:model/GetOrderBook200Response
     * @param {(module:model/ErrorResponse|module:model/OrderBookResponse)} instance The actual instance to initialize GetOrderBook200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "OrderBookResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                OrderBookResponse.validateJSON(instance); // throw an exception if no match
                // create OrderBookResponse from JS object
                this.actualInstance = OrderBookResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into OrderBookResponse
            errorMessages.push("Failed to construct OrderBookResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetOrderBook200Response` with oneOf schemas ErrorResponse, OrderBookResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetOrderBook200Response` with oneOf schemas ErrorResponse, OrderBookResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetOrderBook200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOrderBook200Response} obj Optional instance to populate.
     * @return {module:model/GetOrderBook200Response} The populated <code>GetOrderBook200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetOrderBook200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>OrderBookResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/OrderBookResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>OrderBookResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/OrderBookResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetOrderBook200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetOrderBook200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetOrderBook200Response} An instance of GetOrderBook200Response.
     */
    static fromJSON = function(json_string){
        return GetOrderBook200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetOrderBook200Response.prototype['asks'] = undefined;

/**
 * List of buy orders.
 * @member {Array.<Array.<String>>} bids
 */
GetOrderBook200Response.prototype['bids'] = undefined;

/**
 * Unix timestamp date and time in microseconds.
 * @member {String} microtimestamp
 */
GetOrderBook200Response.prototype['microtimestamp'] = undefined;

/**
 * Unix timestamp date and time.
 * @member {String} timestamp
 */
GetOrderBook200Response.prototype['timestamp'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
GetOrderBook200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetOrderBook200Response.prototype['status'] = undefined;


GetOrderBook200Response.OneOf = ["ErrorResponse", "OrderBookResponse"];

export default GetOrderBook200Response;
