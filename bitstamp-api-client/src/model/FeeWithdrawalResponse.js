...
/**
 * The FeeWithdrawalResponse model module.
 * @module model/FeeWithdrawalResponse
 * @version v2
 */
class FeeWithdrawalResponse {
    /**
     * Constructs a new <code>FeeWithdrawalResponse</code>.
     * @alias module:model/FeeWithdrawalResponse
     */
    constructor() { 
        
        FeeWithdrawalResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FeeWithdrawalResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeeWithdrawalResponse} obj Optional instance to populate.
     * @return {module:model/FeeWithdrawalResponse} The populated <code>FeeWithdrawalResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeeWithdrawalResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FeeWithdrawalResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeeWithdrawalResponse</code>.
     */
 ...
 */
FeeWithdrawalResponse.prototype['currency'] = undefined;

/**
 * Customer withdrawal fee.
 * @member {Number} fee
 */
FeeWithdrawalResponse.prototype['fee'] = undefined;

/**
 * Cryptocurrency network.
 * @member {module:model/FeeWithdrawalResponse.NetworkEnum} network
 */
FeeWithdrawalResponse.prototype['network'] = undefined;
 ...
 * @readonly
 */
FeeWithdrawalResponse['NetworkEnum'] = {
...
export default FeeWithdrawalResponse;
