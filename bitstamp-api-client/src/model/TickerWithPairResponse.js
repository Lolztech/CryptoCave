...
/**
 * The TickerWithPairResponse model module.
 * @module model/TickerWithPairResponse
 * @version v2
 */
class TickerWithPairResponse {
    /**
     * Constructs a new <code>TickerWithPairResponse</code>.
     * @alias module:model/TickerWithPairResponse
     */
    constructor() { 
        
        TickerWithPairResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TickerWithPairResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TickerWithPairResponse} obj Optional instance to populate.
     * @return {module:model/TickerWithPairResponse} The populated <code>TickerWithPairResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TickerWithPairResponse();

            if (data.hasOwnProperty('ask')) {
                obj['ask'] = ApiClient.convertToType(data['ask'], 'String');
            }
            ...
            if (data.hasOwnProperty('open_24')) {
                obj['open_24'] = ApiClient.convertToType(data['open_24'], 'String');
            }
            if (data.hasOwnProperty('pair')) {
                obj['pair'] = ApiClient.convertToType(data['pair'], 'String');
            }
            if (data.hasOwnProperty('percent_change_24')) {
                obj['percent_change_24'] = ApiClient.convertToType(data['percent_change_24'], 'String');
            }
            ...
            if (data.hasOwnProperty('vwap')) {
                obj['vwap'] = ApiClient.convertToType(data['vwap'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TickerWithPairResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TickerWithPairResponse</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['ask'] && !(typeof data['ask'] === 'string' || data['ask'] instanceof String)) {
            throw new Error("Expected the field `ask` to be a primitive type in the JSON string but got " + data['ask']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['open_24'] && !(typeof data['open_24'] === 'string' || data['open_24'] instanceof String)) {
            throw new Error("Expected the field `open_24` to be a primitive type in the JSON string but got " + data['open_24']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['percent_change_24'] && !(typeof data['percent_change_24'] === 'string' || data['percent_change_24'] instanceof String)) {
            throw new Error("Expected the field `percent_change_24` to be a primitive type in the JSON string but got " + data['percent_change_24']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['vwap'] && !(typeof data['vwap'] === 'string' || data['vwap'] instanceof String)) {
            throw new Error("Expected the field `vwap` to be a primitive type in the JSON string but got " + data['vwap']);
        }
 ...
 * @member {String} ask
 */
TickerWithPairResponse.prototype['ask'] = undefined;

/**
 * Highest buy order.
 * @member {String} bid
 */
TickerWithPairResponse.prototype['bid'] = undefined;

/**
 * Last 24 hours price high.
 * @member {String} high
 */
TickerWithPairResponse.prototype['high'] = undefined;

/**
 * Last price.
 * @member {String} last
 */
TickerWithPairResponse.prototype['last'] = undefined;

/**
 * Last 24 hours price low.
 * @member {String} low
 */
TickerWithPairResponse.prototype['low'] = undefined;

/**
 * First price of the day.
 * @member {String} open
 */
TickerWithPairResponse.prototype['open'] = undefined;

/**
 * 24 hours time delta transaction price
 * @member {String} open_24
 */
TickerWithPairResponse.prototype['open_24'] = undefined;

/**
 * Currency pair name
 * @member {String} pair
 */
TickerWithPairResponse.prototype['pair'] = undefined;

/**
 * 24 hours price change percent
 * @member {String} percent_change_24
 */
TickerWithPairResponse.prototype['percent_change_24'] = undefined;

/**
 * Ticker side: 0 - buy; 1 - sell.
 * @member {String} side
 */
TickerWithPairResponse.prototype['side'] = undefined;

/**
 * Unix timestamp date and time.
 * @member {String} timestamp
 */
TickerWithPairResponse.prototype['timestamp'] = undefined;

/**
 * Last 24 hours volume.
 * @member {String} volume
 */
TickerWithPairResponse.prototype['volume'] = undefined;

/**
 * Last 24 hours volume weighted average price.
 * @member {String} vwap
 */
TickerWithPairResponse.prototype['vwap'] = undefined;
...
export default TickerWithPairResponse;
