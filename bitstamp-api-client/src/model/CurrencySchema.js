...
class CurrencySchema {
     ...
     * @param type {module:model/CurrencySchema.TypeEnum} 
     * @param symbol {String} 
     * @param decimals {Number} 
     * @param availableSupply {String} 
     */
    constructor(name, currency, type, symbol, decimals, availableSupply) { 
        
        CurrencySchema.initialize(this, name, currency, type, symbol, decimals, availableSupply);
    }
     ...
     */
    static initialize(obj, name, currency, type, symbol, decimals, availableSupply) { 
        obj['name'] = name;
        obj['currency'] = currency;
        obj['type'] = type;
        obj['symbol'] = symbol;
        obj['decimals'] = decimals;
        obj['available_supply'] = availableSupply;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('available_supply')) {
                obj['available_supply'] = ApiClient.convertToType(data['available_supply'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of CurrencySchema.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['available_supply'] && !(typeof data['available_supply'] === 'string' || data['available_supply'] instanceof String)) {
            throw new Error("Expected the field `available_supply` to be a primitive type in the JSON string but got " + data['available_supply']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['withdrawal'] && !(typeof data['withdrawal'] === 'string' || data['withdrawal'] instanceof String)) {
            throw new Error("Expected the field `withdrawal` to be a primitive type in the JSON string but got " + data['withdrawal']);
        }
...
CurrencySchema.RequiredProperties = ["name", "currency", "type", "symbol", "decimals", "available_supply"];

/**
 * @member {String} name
 */
CurrencySchema.prototype['name'] = undefined;

/**
 * @member {String} currency
 */
CurrencySchema.prototype['currency'] = undefined;

/**
 * @member {module:model/CurrencySchema.TypeEnum} type
 */
CurrencySchema.prototype['type'] = undefined;

/**
 * @member {String} symbol
 */
CurrencySchema.prototype['symbol'] = undefined;

/**
 * @member {Number} decimals
 */
CurrencySchema.prototype['decimals'] = undefined;

/**
 * @member {String} logo
 */
CurrencySchema.prototype['logo'] = undefined;

/**
 * @member {String} available_supply
 */
CurrencySchema.prototype['available_supply'] = undefined;

/**
 * @member {String} deposit
 */
CurrencySchema.prototype['deposit'] = undefined;

/**
 * @member {String} withdrawal
 */
CurrencySchema.prototype['withdrawal'] = undefined;
