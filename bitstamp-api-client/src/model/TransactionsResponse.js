 ...
 */
TransactionsResponse.prototype['amount'] = undefined;

/**
 * Unix timestamp date and time.
 * @member {String} date
 */
TransactionsResponse.prototype['date'] = undefined;

/**
 * Price.
 * @member {String} price
 */
TransactionsResponse.prototype['price'] = undefined;

/**
 * Transaction ID.
 * @member {String} tid
 */
TransactionsResponse.prototype['tid'] = undefined;

/**
 * 0 (buy) or 1 (sell).
 * @member {String} type
 */
TransactionsResponse.prototype['type'] = undefined;
