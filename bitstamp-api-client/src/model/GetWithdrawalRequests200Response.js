...
/**
 * The GetWithdrawalRequests200Response model module.
 * @module model/GetWithdrawalRequests200Response
 * @version v2
 */
class GetWithdrawalRequests200Response {
    /**
     * Constructs a new <code>GetWithdrawalRequests200Response</code>.
     * @alias module:model/GetWithdrawalRequests200Response
     * @param {(module:model/ErrorResponse|module:model/WithdrawalRequestsResponse)} instance The actual instance to initialize GetWithdrawalRequests200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "WithdrawalRequestsResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                WithdrawalRequestsResponse.validateJSON(instance); // throw an exception if no match
                // create WithdrawalRequestsResponse from JS object
                this.actualInstance = WithdrawalRequestsResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into WithdrawalRequestsResponse
            errorMessages.push("Failed to construct WithdrawalRequestsResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetWithdrawalRequests200Response` with oneOf schemas ErrorResponse, WithdrawalRequestsResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetWithdrawalRequests200Response` with oneOf schemas ErrorResponse, WithdrawalRequestsResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetWithdrawalRequests200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetWithdrawalRequests200Response} obj Optional instance to populate.
     * @return {module:model/GetWithdrawalRequests200Response} The populated <code>GetWithdrawalRequests200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetWithdrawalRequests200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>WithdrawalRequestsResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/WithdrawalRequestsResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>WithdrawalRequestsResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/WithdrawalRequestsResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetWithdrawalRequests200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetWithdrawalRequests200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetWithdrawalRequests200Response} An instance of GetWithdrawalRequests200Response.
     */
    static fromJSON = function(json_string){
        return GetWithdrawalRequests200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetWithdrawalRequests200Response.prototype['address'] = undefined;

/**
 * Amount.
 * @member {String} amount
 */
GetWithdrawalRequests200Response.prototype['amount'] = undefined;

/**
 * Currency.
 * @member {String} currency
 */
GetWithdrawalRequests200Response.prototype['currency'] = undefined;

/**
 * Date and time.
 * @member {Date} datetime
 */
GetWithdrawalRequests200Response.prototype['datetime'] = undefined;

/**
 * Withdrawal ID.
 * @member {Number} id
 */
GetWithdrawalRequests200Response.prototype['id'] = undefined;

/**
 * Cryptocurrency network.
 * @member {module:model/GetWithdrawalRequests200Response.NetworkEnum} network
 */
GetWithdrawalRequests200Response.prototype['network'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetWithdrawalRequests200Response.prototype['status'] = undefined;

/**
 * Transaction ID (crypto withdrawals only).
 * @member {String} transaction_id
 */
GetWithdrawalRequests200Response.prototype['transaction_id'] = undefined;

/**
 * Bitstamp's transaction id.
 * @member {Number} txid
 */
GetWithdrawalRequests200Response.prototype['txid'] = undefined;
 ...
 * @member {Number} type
 */
GetWithdrawalRequests200Response.prototype['type'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
GetWithdrawalRequests200Response.prototype['reason'] = undefined;


GetWithdrawalRequests200Response.OneOf = ["ErrorResponse", "WithdrawalRequestsResponse"];

export default GetWithdrawalRequests200Response;
