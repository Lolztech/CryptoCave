...
/**
 * The CryptoTransactionsResponse model module.
 * @module model/CryptoTransactionsResponse
 * @version v2
 */
class CryptoTransactionsResponse {
    /**
     * Constructs a new <code>CryptoTransactionsResponse</code>.
     * @alias module:model/CryptoTransactionsResponse
     */
    constructor() { 
        
        CryptoTransactionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CryptoTransactionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CryptoTransactionsResponse} obj Optional instance to populate.
     * @return {module:model/CryptoTransactionsResponse} The populated <code>CryptoTransactionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CryptoTransactionsResponse();

            if (data.hasOwnProperty('deposits')) {
                obj['deposits'] = ApiClient.convertToType(data['deposits'], [CryptoTransaction]);
            }
            if (data.hasOwnProperty('ripple_iou_transactions')) {
                obj['ripple_iou_transactions'] = ApiClient.convertToType(data['ripple_iou_transactions'], [CryptoTransaction]);
            }
            if (data.hasOwnProperty('withdrawals')) {
                obj['withdrawals'] = ApiClient.convertToType(data['withdrawals'], [CryptoTransaction]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CryptoTransactionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CryptoTransactionsResponse</code>.
     */
    static validateJSON(data) {
        if (data['deposits']) { // data not null
            ...
            for (const item of data['deposits']) {
                CryptoTransaction.validateJSON(item);
            };
        }
        if (data['ripple_iou_transactions']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['ripple_iou_transactions'])) {
                throw new Error("Expected the field `ripple_iou_transactions` to be an array in the JSON data but got " + data['ripple_iou_transactions']);
            }
            // validate the optional field `ripple_iou_transactions` (array)
            for (const item of data['ripple_iou_transactions']) {
                CryptoTransaction.validateJSON(item);
            };
        }
 ...
 */
CryptoTransactionsResponse.prototype['deposits'] = undefined;

/**
 * Ripple IOU transactions.
 * @member {Array.<module:model/CryptoTransaction>} ripple_iou_transactions
 */
CryptoTransactionsResponse.prototype['ripple_iou_transactions'] = undefined;

/**
 * Withdrawals.
 * @member {Array.<module:model/CryptoTransaction>} withdrawals
 */
CryptoTransactionsResponse.prototype['withdrawals'] = undefined;
...
export default CryptoTransactionsResponse;
