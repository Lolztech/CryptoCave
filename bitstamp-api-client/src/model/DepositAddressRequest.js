...
/**
 * The DepositAddressRequest model module.
 * @module model/DepositAddressRequest
 * @version v2
 */
class DepositAddressRequest {
    /**
     * Constructs a new <code>DepositAddressRequest</code>.
     * @alias module:model/DepositAddressRequest
     */
    constructor() { 
        
        DepositAddressRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositAddressRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositAddressRequest} obj Optional instance to populate.
     * @return {module:model/DepositAddressRequest} The populated <code>DepositAddressRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositAddressRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DepositAddressRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositAddressRequest</code>.
     */
 ...
 * @member {module:model/DepositAddressRequest.NetworkEnum} network
 */
DepositAddressRequest.prototype['network'] = undefined;
 ...
 * @readonly
 */
DepositAddressRequest['NetworkEnum'] = {
...
export default DepositAddressRequest;
