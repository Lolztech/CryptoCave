...
import SimpleErrorResponse from './SimpleErrorResponse';
...
class CancelOrder200Response {
     ...
     * @param {(module:model/CancelOrderResponse|module:model/ErrorResponse|module:model/SimpleErrorResponse)} instance The actual instance to initialize CancelOrder200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "CancelOrderResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CancelOrderResponse.validateJSON(instance); // throw an exception if no match
                // create CancelOrderResponse from JS object
                this.actualInstance = CancelOrderResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CancelOrderResponse
            errorMessages.push("Failed to construct CancelOrderResponse: " + err)
        }

        try {
            if (typeof instance === "SimpleErrorResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                SimpleErrorResponse.validateJSON(instance); // throw an exception if no match
                // create SimpleErrorResponse from JS object
                this.actualInstance = SimpleErrorResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into SimpleErrorResponse
            errorMessages.push("Failed to construct SimpleErrorResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `CancelOrder200Response` with oneOf schemas CancelOrderResponse, ErrorResponse, SimpleErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `CancelOrder200Response` with oneOf schemas CancelOrderResponse, ErrorResponse, SimpleErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    static constructFromObject(data, obj) {
        return new CancelOrder200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>CancelOrderResponse</code>, <code>ErrorResponse</code>, <code>SimpleErrorResponse</code>.
     * @return {(module:model/CancelOrderResponse|module:model/ErrorResponse|module:model/SimpleErrorResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CancelOrderResponse</code>, <code>ErrorResponse</code>, <code>SimpleErrorResponse</code>.
     * @param {(module:model/CancelOrderResponse|module:model/ErrorResponse|module:model/SimpleErrorResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = CancelOrder200Response.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/CancelOrder200Response} An instance of CancelOrder200Response.
     */
    static fromJSON = function(json_string){
        return CancelOrder200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 * @member {Number} id
 */
CancelOrder200Response.prototype['id'] = undefined;

/**
 * Order amount.
 * @member {Number} amount
 */
CancelOrder200Response.prototype['amount'] = undefined;

/**
 * Order price.
 * @member {Number} price
 */
CancelOrder200Response.prototype['price'] = undefined;

/**
 * Order type.
 * @member {Number} type
 */
CancelOrder200Response.prototype['type'] = undefined;

/**
 * Market formatted as \"BTC/USD\".
 * @member {String} market
 */
CancelOrder200Response.prototype['market'] = undefined;

/**
 * The reason for the error.
 * @member {String} error
 */
CancelOrder200Response.prototype['error'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
CancelOrder200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
CancelOrder200Response.prototype['status'] = undefined;


CancelOrder200Response.OneOf = ["CancelOrderResponse", "ErrorResponse", "SimpleErrorResponse"];
