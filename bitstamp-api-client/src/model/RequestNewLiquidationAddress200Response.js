...
import NewInstantConvertAddressResponse from './NewInstantConvertAddressResponse';

/**
 * The RequestNewLiquidationAddress200Response model module.
 * @module model/RequestNewLiquidationAddress200Response
 * @version v2
 */
class RequestNewLiquidationAddress200Response {
    /**
     * Constructs a new <code>RequestNewLiquidationAddress200Response</code>.
     * @alias module:model/RequestNewLiquidationAddress200Response
     * @param {(module:model/ErrorResponse|module:model/NewInstantConvertAddressResponse)} instance The actual instance to initialize RequestNewLiquidationAddress200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "NewInstantConvertAddressResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                NewInstantConvertAddressResponse.validateJSON(instance); // throw an exception if no match
                // create NewInstantConvertAddressResponse from JS object
                this.actualInstance = NewInstantConvertAddressResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into NewInstantConvertAddressResponse
            errorMessages.push("Failed to construct NewInstantConvertAddressResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `RequestNewLiquidationAddress200Response` with oneOf schemas ErrorResponse, NewInstantConvertAddressResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `RequestNewLiquidationAddress200Response` with oneOf schemas ErrorResponse, NewInstantConvertAddressResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>RequestNewLiquidationAddress200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestNewLiquidationAddress200Response} obj Optional instance to populate.
     * @return {module:model/RequestNewLiquidationAddress200Response} The populated <code>RequestNewLiquidationAddress200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new RequestNewLiquidationAddress200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>ErrorResponse</code>, <code>NewInstantConvertAddressResponse</code>.
     * @return {(module:model/ErrorResponse|module:model/NewInstantConvertAddressResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ErrorResponse</code>, <code>NewInstantConvertAddressResponse</code>.
     * @param {(module:model/ErrorResponse|module:model/NewInstantConvertAddressResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = RequestNewLiquidationAddress200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of RequestNewLiquidationAddress200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/RequestNewLiquidationAddress200Response} An instance of RequestNewLiquidationAddress200Response.
     */
    static fromJSON = function(json_string){
        return RequestNewLiquidationAddress200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
RequestNewLiquidationAddress200Response.prototype['address'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
RequestNewLiquidationAddress200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
RequestNewLiquidationAddress200Response.prototype['status'] = undefined;


RequestNewLiquidationAddress200Response.OneOf = ["ErrorResponse", "NewInstantConvertAddressResponse"];

export default RequestNewLiquidationAddress200Response;
