...
/**
 * The EarnTransactionSchema model module.
 * @module model/EarnTransactionSchema
 * @version v2
 */
class EarnTransactionSchema {
    /**
     * Constructs a new <code>EarnTransactionSchema</code>.
     * @alias module:model/EarnTransactionSchema
     */
    constructor() { 
        
        EarnTransactionSchema.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EarnTransactionSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EarnTransactionSchema} obj Optional instance to populate.
     * @return {module:model/EarnTransactionSchema} The populated <code>EarnTransactionSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarnTransactionSchema();
    ...
    /**
     * Validates the JSON data with respect to <code>EarnTransactionSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarnTransactionSchema</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['quote_currency'] && !(typeof data['quote_currency'] === 'string' || data['quote_currency'] instanceof String)) {
            throw new Error("Expected the field `quote_currency` to be a primitive type in the JSON string but got " + data['quote_currency']);
        }
        // ensure the json data is a string
 ...
 */
EarnTransactionSchema.prototype['amount'] = undefined;

/**
 * Currency
 * @member {String} currency
 */
EarnTransactionSchema.prototype['currency'] = undefined;

/**
 * Date and time of earn history event
 * @member {Date} datetime
 */
EarnTransactionSchema.prototype['datetime'] = undefined;

/**
 * Currency in which value is calculated
 * @member {String} quote_currency
 */
EarnTransactionSchema.prototype['quote_currency'] = undefined;

/**
 * Status of earn history event
 * @member {module:model/EarnTransactionSchema.StatusEnum} status
 */
EarnTransactionSchema.prototype['status'] = undefined;

/**
 * Type of earn history event
 * @member {module:model/EarnTransactionSchema.TypeEnum} type
 */
EarnTransactionSchema.prototype['type'] = undefined;

/**
 * Amount in quote currency
 * @member {Number} value
 */
EarnTransactionSchema.prototype['value'] = undefined;
 ...
 * @readonly
 */
EarnTransactionSchema['StatusEnum'] = {
 ...
 * @readonly
 */
EarnTransactionSchema['TypeEnum'] = {
...
export default EarnTransactionSchema;
