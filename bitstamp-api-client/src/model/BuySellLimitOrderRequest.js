...
/**
 * The BuySellLimitOrderRequest model module.
 * @module model/BuySellLimitOrderRequest
 * @version v2
 */
class BuySellLimitOrderRequest {
    /**
     * Constructs a new <code>BuySellLimitOrderRequest</code>.
     * @alias module:model/BuySellLimitOrderRequest
     * @param amount {Number} Amount.
     * @param price {Number} Price.
     */
    constructor(amount, price) { 
        
        BuySellLimitOrderRequest.initialize(this, amount, price);
    }
     ...
     */
    static initialize(obj, amount, price) { 
        obj['amount'] = amount;
        obj['price'] = price;
    }

    /**
     * Constructs a <code>BuySellLimitOrderRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuySellLimitOrderRequest} obj Optional instance to populate.
     * @return {module:model/BuySellLimitOrderRequest} The populated <code>BuySellLimitOrderRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuySellLimitOrderRequest();
            ...
            if (data.hasOwnProperty('daily_order')) {
                obj['daily_order'] = ApiClient.convertToType(data['daily_order'], 'Boolean');
            }
            if (data.hasOwnProperty('ioc_order')) {
                obj['ioc_order'] = ApiClient.convertToType(data['ioc_order'], 'Boolean');
            }
            if (data.hasOwnProperty('fok_order')) {
                obj['fok_order'] = ApiClient.convertToType(data['fok_order'], 'Boolean');
            }
            if (data.hasOwnProperty('moc_order')) {
                obj['moc_order'] = ApiClient.convertToType(data['moc_order'], 'Boolean');
            }
            if (data.hasOwnProperty('gtd_order')) {
                obj['gtd_order'] = ApiClient.convertToType(data['gtd_order'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BuySellLimitOrderRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BuySellLimitOrderRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BuySellLimitOrderRequest.RequiredProperties) {
...
BuySellLimitOrderRequest.RequiredProperties = ["amount", "price"];

/**
 * Amount.
 * @member {Number} amount
 */
BuySellLimitOrderRequest.prototype['amount'] = undefined;

/**
 * Price.
 * @member {Number} price
 */
BuySellLimitOrderRequest.prototype['price'] = undefined;

/**
 * If the order gets executed, a new sell order will be placed, with \"limit_price\" as its price.
 * @member {Number} limit_price
 */
BuySellLimitOrderRequest.prototype['limit_price'] = undefined;

/**
 * Opens buy limit order which will be canceled at 0:00 UTC unless it already has been executed.
 * @member {Boolean} daily_order
 */
BuySellLimitOrderRequest.prototype['daily_order'] = undefined;
 ...
 * @member {Boolean} ioc_order
 */
BuySellLimitOrderRequest.prototype['ioc_order'] = undefined;
 ...
 * @member {Boolean} fok_order
 */
BuySellLimitOrderRequest.prototype['fok_order'] = undefined;
 ...
 * @member {Boolean} moc_order
 */
BuySellLimitOrderRequest.prototype['moc_order'] = undefined;
 ...
 * @member {Boolean} gtd_order
 */
BuySellLimitOrderRequest.prototype['gtd_order'] = undefined;

/**
 * Unix timestamp in milliseconds. Required in case of GTD order.
 * @member {Number} expire_time
 */
BuySellLimitOrderRequest.prototype['expire_time'] = undefined;
 ...
 */
BuySellLimitOrderRequest.prototype['client_order_id'] = undefined;
...
export default BuySellLimitOrderRequest;
