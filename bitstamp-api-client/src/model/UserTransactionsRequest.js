...
/**
 * The UserTransactionsRequest model module.
 * @module model/UserTransactionsRequest
 * @version v2
 */
class UserTransactionsRequest {
    /**
     * Constructs a new <code>UserTransactionsRequest</code>.
     * @alias module:model/UserTransactionsRequest
     */
    constructor() { 
        
        UserTransactionsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserTransactionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserTransactionsRequest} obj Optional instance to populate.
     * @return {module:model/UserTransactionsRequest} The populated <code>UserTransactionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserTransactionsRequest();
            ...
            if (data.hasOwnProperty('since_id')) {
                obj['since_id'] = ApiClient.convertToType(data['since_id'], 'String');
            }
            ...
            if (data.hasOwnProperty('until_timestamp')) {
                obj['until_timestamp'] = ApiClient.convertToType(data['until_timestamp'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserTransactionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserTransactionsRequest</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['since_id'] && !(typeof data['since_id'] === 'string' || data['since_id'] instanceof String)) {
            throw new Error("Expected the field `since_id` to be a primitive type in the JSON string but got " + data['since_id']);
        }
        // ensure the json data is a string
        if (data['since_timestamp'] && !(typeof data['since_timestamp'] === 'string' || data['since_timestamp'] instanceof String)) {
            throw new Error("Expected the field `since_timestamp` to be a primitive type in the JSON string but got " + data['since_timestamp']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['until_timestamp'] && !(typeof data['until_timestamp'] === 'string' || data['until_timestamp'] instanceof String)) {
            throw new Error("Expected the field `until_timestamp` to be a primitive type in the JSON string but got " + data['until_timestamp']);
        }
 ...
 * @member {String} limit
 */
UserTransactionsRequest.prototype['limit'] = undefined;
 ...
 */
UserTransactionsRequest.prototype['offset'] = undefined;
 ...
 * @member {String} since_id
 */
UserTransactionsRequest.prototype['since_id'] = undefined;

/**
 * (Optional) Show only transactions from unix timestamp (for max 30 days old).
 * @member {String} since_timestamp
 */
UserTransactionsRequest.prototype['since_timestamp'] = undefined;

/**
 * Sorting by date and time: asc - ascending; desc - descending (default: desc).
 * @member {String} sort
 */
UserTransactionsRequest.prototype['sort'] = undefined;

/**
 * Show only transactions to unix timestamp (for max 30 days old).
 * @member {String} until_timestamp
 */
UserTransactionsRequest.prototype['until_timestamp'] = undefined;
...
export default UserTransactionsRequest;
