...
/**
 * The GetUnconfirmedBTCDeposits200Response model module.
 * @module model/GetUnconfirmedBTCDeposits200Response
 * @version v2
 */
class GetUnconfirmedBTCDeposits200Response {
    /**
     * Constructs a new <code>GetUnconfirmedBTCDeposits200Response</code>.
     * @alias module:model/GetUnconfirmedBTCDeposits200Response
     * @param {(module:model/DepositAddressResponse|module:model/ErrorResponse)} instance The actual instance to initialize GetUnconfirmedBTCDeposits200Response.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "DepositAddressResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                DepositAddressResponse.validateJSON(instance); // throw an exception if no match
                // create DepositAddressResponse from JS object
                this.actualInstance = DepositAddressResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into DepositAddressResponse
            errorMessages.push("Failed to construct DepositAddressResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetUnconfirmedBTCDeposits200Response` with oneOf schemas DepositAddressResponse, ErrorResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetUnconfirmedBTCDeposits200Response` with oneOf schemas DepositAddressResponse, ErrorResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetUnconfirmedBTCDeposits200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUnconfirmedBTCDeposits200Response} obj Optional instance to populate.
     * @return {module:model/GetUnconfirmedBTCDeposits200Response} The populated <code>GetUnconfirmedBTCDeposits200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetUnconfirmedBTCDeposits200Response(data);
    }

    /**
     * Gets the actual instance, which can be <code>DepositAddressResponse</code>, <code>ErrorResponse</code>.
     * @return {(module:model/DepositAddressResponse|module:model/ErrorResponse)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>DepositAddressResponse</code>, <code>ErrorResponse</code>.
     * @param {(module:model/DepositAddressResponse|module:model/ErrorResponse)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetUnconfirmedBTCDeposits200Response.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GetUnconfirmedBTCDeposits200Response from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetUnconfirmedBTCDeposits200Response} An instance of GetUnconfirmedBTCDeposits200Response.
     */
    static fromJSON = function(json_string){
        return GetUnconfirmedBTCDeposits200Response.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetUnconfirmedBTCDeposits200Response.prototype['address'] = undefined;

/**
 * Destination tag in case of currency XRP or Ripple, otherwise not present.
 * @member {Number} destination_tag
 */
GetUnconfirmedBTCDeposits200Response.prototype['destination_tag'] = undefined;

/**
 * Memo ID in case of network HBAR or XLM, otherwise not present.
 * @member {String} memo_id
 */
GetUnconfirmedBTCDeposits200Response.prototype['memo_id'] = undefined;

/**
 * Transfer ID in case of network CSPR, otherwise not present.
 * @member {Number} transfer_id
 */
GetUnconfirmedBTCDeposits200Response.prototype['transfer_id'] = undefined;

/**
 * Error reason.
 * @member {String} reason
 */
GetUnconfirmedBTCDeposits200Response.prototype['reason'] = undefined;

/**
 * \"error\"
 * @member {String} status
 */
GetUnconfirmedBTCDeposits200Response.prototype['status'] = undefined;


GetUnconfirmedBTCDeposits200Response.OneOf = ["DepositAddressResponse", "ErrorResponse"];

export default GetUnconfirmedBTCDeposits200Response;
