...
/**
 * The OpenOrdersAllResponse model module.
 * @module model/OpenOrdersAllResponse
 * @version v2
 */
class OpenOrdersAllResponse {
    /**
     * Constructs a new <code>OpenOrdersAllResponse</code>.
     * @alias module:model/OpenOrdersAllResponse
     */
    constructor() { 
        
        OpenOrdersAllResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpenOrdersAllResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenOrdersAllResponse} obj Optional instance to populate.
     * @return {module:model/OpenOrdersAllResponse} The populated <code>OpenOrdersAllResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenOrdersAllResponse();
            ...
            if (data.hasOwnProperty('amount_at_create')) {
                obj['amount_at_create'] = ApiClient.convertToType(data['amount_at_create'], 'String');
            }
            ...
            if (data.hasOwnProperty('limit_price')) {
                obj['limit_price'] = ApiClient.convertToType(data['limit_price'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OpenOrdersAllResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpenOrdersAllResponse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['amount_at_create'] && !(typeof data['amount_at_create'] === 'string' || data['amount_at_create'] instanceof String)) {
            throw new Error("Expected the field `amount_at_create` to be a primitive type in the JSON string but got " + data['amount_at_create']);
        }
        // ensure the json data is a string
        if (data['currency_pair'] && !(typeof data['currency_pair'] === 'string' || data['currency_pair'] instanceof String)) {
            throw new Error("Expected the field `currency_pair` to be a primitive type in the JSON string but got " + data['currency_pair']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['limit_price'] && !(typeof data['limit_price'] === 'string' || data['limit_price'] instanceof String)) {
            throw new Error("Expected the field `limit_price` to be a primitive type in the JSON string but got " + data['limit_price']);
        }
        // ensure the json data is a string
 ...
 * @member {String} id
 */
OpenOrdersAllResponse.prototype['id'] = undefined;

/**
 * Date and time.
 * @member {String} datetime
 */
OpenOrdersAllResponse.prototype['datetime'] = undefined;

/**
 * Order type: 0 - buy; 1 - sell.
 * @member {String} type
 */
OpenOrdersAllResponse.prototype['type'] = undefined;

/**
 * Price.
 * @member {String} price
 */
OpenOrdersAllResponse.prototype['price'] = undefined;

/**
 * Remaining amount.
 * @member {String} amount
 */
OpenOrdersAllResponse.prototype['amount'] = undefined;

/**
 * Initial amount.
 * @member {String} amount_at_create
 */
OpenOrdersAllResponse.prototype['amount_at_create'] = undefined;

/**
 * Currency Pair (deprecated).
 * @member {String} currency_pair
 */
OpenOrdersAllResponse.prototype['currency_pair'] = undefined;

/**
 * Market formatted as \"BTC/USD\".
 * @member {String} market
 */
OpenOrdersAllResponse.prototype['market'] = undefined;

/**
 * Limit price. (Only returned if limit order was placed with limit_price parameter.)
 * @member {String} limit_price
 */
OpenOrdersAllResponse.prototype['limit_price'] = undefined;

/**
 * Client order id. (Only returned if order was placed with client order id parameter.)
 * @member {String} client_order_id
 */
OpenOrdersAllResponse.prototype['client_order_id'] = undefined;
...
export default OpenOrdersAllResponse;
