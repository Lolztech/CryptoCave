...
/**
* MarketInfo service.
* @module api/MarketInfoApi
* @version v2
*/
export default class MarketInfoApi {

    /**
    * Constructs a new MarketInfoApi. 
    * @alias module:api/MarketInfoApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getEURUSDConversionRate operation.
     * @callback module:api/MarketInfoApi~getEURUSDConversionRateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EurUsdConversionRateResponse} data The data returned by the service call.
     ...
     * @param {module:api/MarketInfoApi~getEURUSDConversionRateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EurUsdConversionRateResponse}
     */
    getEURUSDConversionRate(callback) {
      let postBody = null;
      ...
      let returnType = EurUsdConversionRateResponse;
    ...
    /**
     * Callback function to receive the result of the getOHLCData operation.
     * @callback module:api/MarketInfoApi~getOHLCDataCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetOHLCData200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/Number} step Timeframe in seconds.
     * @param {Number} limit Limit OHLC results.
     * @param {Object} opts Optional parameters
     * @param {Number} [start] Unix timestamp from when OHLC data will be started.
     * @param {Number} [end] Unix timestamp to when OHLC data will be shown.If none from start or end timestamps are posted then endpoint returns OHLC data to current unixtime. If both start and end timestamps are posted, end timestamp will be used.
     * @param {Boolean} [excludeCurrentCandle = false)] If set, results won't include current (open) candle.
     * @param {module:api/MarketInfoApi~getOHLCDataCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetOHLCData200Response}
     */
    getOHLCData(marketSymbol, step, limit, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'marketSymbol' is set
      if (marketSymbol === undefined || marketSymbol === null) {
        throw new Error("Missing the required parameter 'marketSymbol' when calling getOHLCData");
      }
      // verify the required parameter 'step' is set
      if (step === undefined || step === null) {
        throw new Error("Missing the required parameter 'step' when calling getOHLCData");
      }
      // verify the required parameter 'limit' is set
      if (limit === undefined || limit === null) {
        throw new Error("Missing the required parameter 'limit' when calling getOHLCData");
      }
      ...
      let queryParams = {
        ...
        'start': opts['start'],
        'end': opts['end'],
        'exclude_current_candle': opts['excludeCurrentCandle']
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetOHLCData200Response;
      return this.apiClient.callApi(
        '/api/v2/ohlc/{market_symbol}/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getTradingPairsInfo operation.
     * @callback module:api/MarketInfoApi~getTradingPairsInfoCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TradingPairsInfoResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MarketInfoApi~getTradingPairsInfoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TradingPairsInfoResponse}
     */
    getTradingPairsInfo(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TradingPairsInfoResponse;
      return this.apiClient.callApi(
        '/api/v2/trading-pairs-info/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
