...
export default class TickersApi {
    ...
    */
     ...
     * @callback module:api/TickersApi~getCurrenciesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/CurrencySchema>} data The data returned by the service call.
     ...
     * @param {module:api/TickersApi~getCurrenciesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CurrencySchema>}
     */
    ...
    /**
     * Callback function to receive the result of the getCurrencyPairTickers operation.
     * @callback module:api/TickersApi~getCurrencyPairTickersCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/TickerWithPairResponse>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TickersApi~getCurrencyPairTickersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/TickerWithPairResponse>}
     */
    getCurrencyPairTickers(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [TickerWithPairResponse];
      return this.apiClient.callApi(
        '/api/v2/ticker/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getHourlyCurrencyPairTicker operation.
     * @callback module:api/TickersApi~getHourlyCurrencyPairTickerCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TickerHourResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TickersApi~getHourlyCurrencyPairTickerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TickerHourResponse}
     */
    getHourlyCurrencyPairTicker(marketSymbol, callback) {
      let postBody = null;
      // verify the required parameter 'marketSymbol' is set
      if (marketSymbol === undefined || marketSymbol === null) {
        throw new Error("Missing the required parameter 'marketSymbol' when calling getHourlyCurrencyPairTicker");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TickerHourResponse;
      return this.apiClient.callApi(
        '/api/v2/ticker_hour/{market_symbol}/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getMarketTicker operation.
     * @callback module:api/TickersApi~getMarketTickerCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} marketSymbol 
     * @param {module:api/TickersApi~getMarketTickerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TickerResponse}
     */
    getMarketTicker(marketSymbol, callback) {
      let postBody = null;
      // verify the required parameter 'marketSymbol' is set
      if (marketSymbol === undefined || marketSymbol === null) {
        throw new Error("Missing the required parameter 'marketSymbol' when calling getMarketTicker");
      }
      ...
      return this.apiClient.callApi(
        '/api/v2/ticker/{market_symbol}/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
