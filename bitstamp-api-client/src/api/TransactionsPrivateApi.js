...
/**
* TransactionsPrivate service.
* @module api/TransactionsPrivateApi
* @version v2
*/
export default class TransactionsPrivateApi {

    /**
    * Constructs a new TransactionsPrivateApi. 
    * @alias module:api/TransactionsPrivateApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getCryptoUserTransactions operation.
     * @callback module:api/TransactionsPrivateApi~getCryptoUserTransactionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetCryptoUserTransactions200Response} data The data returned by the service call.
     ...
     * @param {module:model/CryptoTransactionsRequest} [cryptoTransactionsRequest] 
     * @param {module:api/TransactionsPrivateApi~getCryptoUserTransactionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetCryptoUserTransactions200Response}
     */
    getCryptoUserTransactions(opts, callback) {
      opts = opts || {};
      let postBody = opts['cryptoTransactionsRequest'];
      ...
      let returnType = GetCryptoUserTransactions200Response;
      return this.apiClient.callApi(
        '/api/v2/crypto-transactions/', 'POST',
     ...
     * @callback module:api/TransactionsPrivateApi~getUserTransactionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetUserTransactions200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/UserTransactionsRequest} [userTransactionsRequest] 
     * @param {module:api/TransactionsPrivateApi~getUserTransactionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUserTransactions200Response}
     */
    getUserTransactions(opts, callback) {
      opts = opts || {};
      let postBody = opts['userTransactionsRequest'];
      ...
      let contentTypes = ['www-form-urlencoded'];
      let accepts = ['application/json'];
      let returnType = GetUserTransactions200Response;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getUserTransactionsForMarket operation.
     * @callback module:api/TransactionsPrivateApi~getUserTransactionsForMarketCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetUserTransactions200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/UserTransactionsRequest} [userTransactionsRequest] 
     * @param {module:api/TransactionsPrivateApi~getUserTransactionsForMarketCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUserTransactions200Response}
     */
    getUserTransactionsForMarket(marketSymbol, opts, callback) {
      opts = opts || {};
      let postBody = opts['userTransactionsRequest'];
      // verify the required parameter 'marketSymbol' is set
      if (marketSymbol === undefined || marketSymbol === null) {
        throw new Error("Missing the required parameter 'marketSymbol' when calling getUserTransactionsForMarket");
      }
      ...
      let returnType = GetUserTransactions200Response;
      return this.apiClient.callApi(
        '/api/v2/user_transactions/{market_symbol}/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
