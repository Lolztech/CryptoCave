...
export default class FeesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllTradingFees operation.
     * @callback module:api/FeesApi~getAllTradingFeesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/FeeTradingResponse>} data The data returned by the service call.
     ...
     * @param {module:api/FeesApi~getAllTradingFeesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/FeeTradingResponse>}
     */
    getAllTradingFees(callback) {
      let postBody = null;
      ...
      let returnType = [FeeTradingResponse];
      return this.apiClient.callApi(
        '/api/v2/fees/trading/', 'POST',
    ...
    /**
     * Callback function to receive the result of the getAllWithdrawalFees operation.
     * @callback module:api/FeesApi~getAllWithdrawalFeesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/FeeWithdrawalResponse>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FeesApi~getAllWithdrawalFeesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/FeeWithdrawalResponse>}
     */
    getAllWithdrawalFees(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [FeeWithdrawalResponse];
      return this.apiClient.callApi(
        '/api/v2/fees/withdrawal/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getTradingFeesForCurrency operation.
     * @callback module:api/FeesApi~getTradingFeesForCurrencyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeeTradingResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/FeesApi~getTradingFeesForCurrencyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeeTradingResponse}
     */
    getTradingFeesForCurrency(marketSymbol, callback) {
      let postBody = null;
      // verify the required parameter 'marketSymbol' is set
      if (marketSymbol === undefined || marketSymbol === null) {
        throw new Error("Missing the required parameter 'marketSymbol' when calling getTradingFeesForCurrency");
      }
      ...
      let returnType = FeeTradingResponse;
      return this.apiClient.callApi(
        '/api/v2/fees/trading/{market_symbol}/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getWithdrawalFeeForCurrency operation.
     * @callback module:api/FeesApi~getWithdrawalFeeForCurrencyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FeeWithdrawalResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/FeeWithdrawalRequest} [feeWithdrawalRequest] 
     * @param {module:api/FeesApi~getWithdrawalFeeForCurrencyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FeeWithdrawalResponse}
     */
    getWithdrawalFeeForCurrency(currency, opts, callback) {
      opts = opts || {};
      let postBody = opts['feeWithdrawalRequest'];
      // verify the required parameter 'currency' is set
      if (currency === undefined || currency === null) {
        throw new Error("Missing the required parameter 'currency' when calling getWithdrawalFeeForCurrency");
      }
      ...
      let returnType = FeeWithdrawalResponse;
      return this.apiClient.callApi(
        '/api/v2/fees/withdrawal/{currency}/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
