...
* @version v2
*/
export default class EarnApi {

    /**
    * Constructs a new EarnApi. 
    * @alias module:api/EarnApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the earnSubscribe operation.
     * @callback module:api/EarnApi~earnSubscribeCallback
     ...
     * @param {module:model/EarnSubscriptionSchema} [earnSubscriptionSchema] 
     * @param {module:api/EarnApi~earnSubscribeCallback} callback The callback function, accepting three arguments: error, data, response
     */
    earnSubscribe(opts, callback) {
      opts = opts || {};
      let postBody = opts['earnSubscriptionSchema'];
    ...
    /**
     * Callback function to receive the result of the earnSubscriptions operation.
     * @callback module:api/EarnApi~earnSubscriptionsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EarnSubscriptionsSchema>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/EarnApi~earnSubscriptionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EarnSubscriptionsSchema>}
     */
    earnSubscriptions(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [EarnSubscriptionsSchema];
      return this.apiClient.callApi(
        '/api/v2/earn/subscriptions/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the earnSubscriptionsSetting operation.
     * @callback module:api/EarnApi~earnSubscriptionsSettingCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/EarnSubscriptionSettingSchema} [earnSubscriptionSettingSchema] 
     * @param {module:api/EarnApi~earnSubscriptionsSettingCallback} callback The callback function, accepting three arguments: error, data, response
     */
    earnSubscriptionsSetting(opts, callback) {
      opts = opts || {};
      let postBody = opts['earnSubscriptionSettingSchema'];
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/v2/earn/subscriptions/setting/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the earnTransactions operation.
     * @callback module:api/EarnApi~earnTransactionsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EarnTransactionSchema>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [limit = 100)] Limit result to that many events (default: 100; maximum: 1000)
     * @param {Number} [offset = 0)] Skip that many events before returning results (default: 0, maximum: 200000)
     * @param {String} [quoteCurrency] Currency in which value is calculated
     * @param {module:api/EarnApi~earnTransactionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EarnTransactionSchema>}
     */
    earnTransactions(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [EarnTransactionSchema];
      return this.apiClient.callApi(
        '/api/v2/earn/transactions/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the earnUnsubscribe operation.
     * @callback module:api/EarnApi~earnUnsubscribeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/EarnSubscriptionSchema} [earnSubscriptionSchema] 
     * @param {module:api/EarnApi~earnUnsubscribeCallback} callback The callback function, accepting three arguments: error, data, response
     */
    earnUnsubscribe(opts, callback) {
      opts = opts || {};
      let postBody = opts['earnSubscriptionSchema'];
