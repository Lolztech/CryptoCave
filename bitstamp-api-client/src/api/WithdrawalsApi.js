...
export default class WithdrawalsApi {
    ...
    /**
    * Constructs a new WithdrawalsApi. 
    * @alias module:api/WithdrawalsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the cancelWithdrawal operation.
     * @callback module:api/WithdrawalsApi~cancelWithdrawalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CancelWithdrawal200Response} data The data returned by the service call.
     ...
     * @param {module:model/CancelBankOrCryptoWithdrawalRequest} [cancelBankOrCryptoWithdrawalRequest] 
     * @param {module:api/WithdrawalsApi~cancelWithdrawalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CancelWithdrawal200Response}
     */
    cancelWithdrawal(opts, callback) {
      opts = opts || {};
      let postBody = opts['cancelBankOrCryptoWithdrawalRequest'];
      ...
      let returnType = CancelWithdrawal200Response;
      return this.apiClient.callApi(
        '/api/v2/withdrawal/cancel/', 'POST',
    ...
    /**
     * Callback function to receive the result of the getFiatWithdrawalStatus operation.
     * @callback module:api/WithdrawalsApi~getFiatWithdrawalStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetFiatWithdrawalStatus200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/BankWithdrawalStatusRequest} [bankWithdrawalStatusRequest] 
     * @param {module:api/WithdrawalsApi~getFiatWithdrawalStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetFiatWithdrawalStatus200Response}
     */
    getFiatWithdrawalStatus(opts, callback) {
      opts = opts || {};
      let postBody = opts['bankWithdrawalStatusRequest'];
      ...
      let contentTypes = ['www-form-urlencoded'];
      let accepts = ['application/json'];
      let returnType = GetFiatWithdrawalStatus200Response;
      return this.apiClient.callApi(
        '/api/v2/withdrawal/status/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/WithdrawalsApi~getWithdrawalRequestsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetWithdrawalRequests200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/WithdrawalRequestsRequest} [withdrawalRequestsRequest] 
     * @param {module:api/WithdrawalsApi~getWithdrawalRequestsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetWithdrawalRequests200Response}
     */
    getWithdrawalRequests(opts, callback) {
      opts = opts || {};
      let postBody = opts['withdrawalRequestsRequest'];
      ...
      let contentTypes = ['www-form-urlencoded'];
      let accepts = ['application/json'];
      let returnType = GetWithdrawalRequests200Response;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the requestCryptoWithdrawal operation.
     * @callback module:api/WithdrawalsApi~requestCryptoWithdrawalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RequestCryptoWithdrawal200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CryptoWithdrawalRequest} [cryptoWithdrawalRequest] 
     * @param {module:api/WithdrawalsApi~requestCryptoWithdrawalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RequestCryptoWithdrawal200Response}
     */
    requestCryptoWithdrawal(currency, opts, callback) {
      opts = opts || {};
      let postBody = opts['cryptoWithdrawalRequest'];
      // verify the required parameter 'currency' is set
      if (currency === undefined || currency === null) {
        throw new Error("Missing the required parameter 'currency' when calling requestCryptoWithdrawal");
      }
      ...
      let contentTypes = ['www-form-urlencoded'];
      let accepts = ['application/json'];
      let returnType = RequestCryptoWithdrawal200Response;
      return this.apiClient.callApi(
        '/api/v2/{currency}_withdrawal/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the requestFiatWithdrawal operation.
     * @callback module:api/WithdrawalsApi~requestFiatWithdrawalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RequestFiatWithdrawal200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/OpenBankWithdrawalRequest} [openBankWithdrawalRequest] 
     * @param {module:api/WithdrawalsApi~requestFiatWithdrawalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RequestFiatWithdrawal200Response}
     */
    requestFiatWithdrawal(opts, callback) {
      opts = opts || {};
      let postBody = opts['openBankWithdrawalRequest'];
      ...
      let contentTypes = ['www-form-urlencoded'];
      let accepts = ['application/json'];
      let returnType = RequestFiatWithdrawal200Response;
      return this.apiClient.callApi(
        '/api/v2/withdrawal/open/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the requestRippleIOUWithdrawal operation.
     * @callback module:api/WithdrawalsApi~requestRippleIOUWithdrawalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RequestRippleIOUWithdrawal200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/RippleIOUWithdrawalRequest} [rippleIOUWithdrawalRequest] 
     * @param {module:api/WithdrawalsApi~requestRippleIOUWithdrawalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RequestRippleIOUWithdrawal200Response}
     */
    requestRippleIOUWithdrawal(opts, callback) {
      opts = opts || {};
      let postBody = opts['rippleIOUWithdrawalRequest'];
      ...
      let contentTypes = ['www-form-urlencoded'];
      let accepts = ['application/json'];
      let returnType = RequestRippleIOUWithdrawal200Response;
      return this.apiClient.callApi(
        '/api/v2/ripple_withdrawal/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
