...
/**
* TravelRulePrivate service.
* @module api/TravelRulePrivateApi
* @version v2
*/
export default class TravelRulePrivateApi {

    /**
    * Constructs a new TravelRulePrivateApi. 
    * @alias module:api/TravelRulePrivateApi
    * @class
    ...
    */
     ...
     * @callback module:api/TravelRulePrivateApi~createContactCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ContactSchema} data The data returned by the service call.
     ...
     * @param {module:model/ContactSchema} [contactSchema] 
     * @param {module:api/TravelRulePrivateApi~createContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ContactSchema}
     */
    createContact(opts, callback) {
      opts = opts || {};
      let postBody = opts['contactSchema'];
      ...
      let returnType = ContactSchema;
      return this.apiClient.callApi(
        '/api/v2/travel_rule/contacts/', 'POST',
     ...
     * @callback module:api/TravelRulePrivateApi~getAllContactsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ContactSchema>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [page] 
     * @param {module:api/TravelRulePrivateApi~getAllContactsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ContactSchema>}
     */
    getAllContacts(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = [ContactSchema];
      return this.apiClient.callApi(
        '/api/v2/travel_rule/contacts/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/TravelRulePrivateApi~getContactCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ContactSchema} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TravelRulePrivateApi~getContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ContactSchema}
     */
    getContact(contactUuid, callback) {
      let postBody = null;
      // verify the required parameter 'contactUuid' is set
      if (contactUuid === undefined || contactUuid === null) {
        throw new Error("Missing the required parameter 'contactUuid' when calling getContact");
      }
      ...
      let returnType = ContactSchema;
      return this.apiClient.callApi(
        '/api/v2/travel_rule/contacts/{contact_uuid}/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
