...
export default class DepositsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getCryptoDepositAddress operation.
     * @callback module:api/DepositsApi~getCryptoDepositAddressCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetUnconfirmedBTCDeposits200Response} data The data returned by the service call.
     ...
     * @param {module:model/DepositAddressRequest} [depositAddressRequest] 
     * @param {module:api/DepositsApi~getCryptoDepositAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUnconfirmedBTCDeposits200Response}
     */
    getCryptoDepositAddress(currency, opts, callback) {
      opts = opts || {};
      let postBody = opts['depositAddressRequest'];
      // verify the required parameter 'currency' is set
      if (currency === undefined || currency === null) {
        throw new Error("Missing the required parameter 'currency' when calling getCryptoDepositAddress");
      }
      ...
      let returnType = GetUnconfirmedBTCDeposits200Response;
      return this.apiClient.callApi(
        '/api/v2/{currency}_address/', 'POST',
    ...
    /**
     * Callback function to receive the result of the getRippleIOUDepositAddress operation.
     * @callback module:api/DepositsApi~getRippleIOUDepositAddressCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetRippleIOUDepositAddress200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DepositsApi~getRippleIOUDepositAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetRippleIOUDepositAddress200Response}
     */
    getRippleIOUDepositAddress(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetRippleIOUDepositAddress200Response;
      return this.apiClient.callApi(
        '/api/v2/ripple_address/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getUnconfirmedBTCDeposits operation.
     * @callback module:api/DepositsApi~getUnconfirmedBTCDepositsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetUnconfirmedBTCDeposits200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DepositsApi~getUnconfirmedBTCDepositsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUnconfirmedBTCDeposits200Response}
     */
    getUnconfirmedBTCDeposits(callback) {
      let postBody = null;
